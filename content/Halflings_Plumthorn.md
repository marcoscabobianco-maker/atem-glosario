...
- **Extorsión** — demandan **tributo** a quien entre por la puerta norte
- **Manufactura de veneno** — receta **particularmente virulenta** que comercian **clandestinamente** en el exarchate de [[Narsileon]]
- **Matones de entrada** — primera línea de hostilidad para los aventureros novatos

### Estructura

- **Phlebotomas Plumthorn** — líder
- **Roskelly Winterleaf** — halfling thug subordinado
- **3 guerreros halflings** — cuero tachonado y escudo; lanzas, garrotes y hondas
- **3 ladrones halflings** — cuero ligero; espadas cortas, dagas y hondas. Dedos rápidos, paso silencioso, trepadores consumados
...
- **el archivo** — encuentro probable inicial ([[Buscadores_de_Ardis_Vala|Buscadores]] entrando al dungeon)
- Jornadas posteriores — presencia residual o eliminación
