...
aliases:
 ...
 - Ardispitecus
 - Arquipiédrus
 - El primer Ardipiédrus
 - El Proto-Guardián
 - Graz'zt-Ardipithecus
 - El que se guardó en la flecha
categoria_diegetica: entidad
epoca: "anterior a la diferencia hombre-demonio; emergencia documentada en el regreso tras el Hiato"
ubicacion_principal: "escondido en la espada compañera de Valerius; emergencia en el círculo del Palacio del Prisma"
tags:
 - principe-demonio
 - grazzt
 - proto-guardian
...
**Ardipithecus** —*"el simio de Ardi"*, donde **Ardi** vuelve a decir lo que ya se dijo en otra entrada del archivo: **lugar de la flecha**, **punto donde la flecha cae**, **donde se decide**—. El homínido fósil que la ciencia profana data en 4.4 millones de años lleva ese nombre por su yacimiento. La cifra cosmológica del Glosario lo lleva por la misma razón, doblada: **Ardi** ya nombró el valle de [[Vala|Vala]] —**[[Arden_Vul|Ardisvala]]**—; **Ardi** vuelve a nombrar al que se guardó en el valle.
...
1. **Forma proto-humana ancestral** — anterior a la separación, *anterior a que el hombre supiera que no era simio y el demonio supiera que no era hombre*.
2. **[[Grazzt|Graz'zt]] en su aspecto más antiguo y más oculto** — la identidad que el príncipe demoníaco no admite en concilio pero conserva como reserva.
3. **Proto-guardián auto-elegido** — *no fue desterrado al escondite, eligió esconderse*. La distinción importa: en la cosmología decadiana, el desterrado vuelve por venganza; el que se esconde vuelve por **plan**.
...
El círculo del **[[Palacio_del_Prisma|Palacio del Prisma]]**. Los [[Buscadores_de_Ardis_Vala|Buscadores]] enfrentados a un emisario demoníaco —**[[Labresu]] mismo, o un agente cercano**— que ofrece devolver **la espada y la llave del Circuito de Medianoche** a cambio de lo que sus pares cobran.
...
- [[Grazzt|Graz'zt]] — identidad mayor de la que Ardipithecus es aspecto proto
- [[GRDT|Geredet]] — avatar abisinio de Graz'zt; mismo suelo, era intermedia
- [[Axum_MC|Axum / Abisinia / Etiopía]] — matriz geográfica del Proto-Guardián; cuna del fósil ancestral
- **Pentáculo abisinio** — sello del Proto-Guardián en el estandarte oficial
- [[Maleika_Maleyka]] — la que disminuyó a Graz'zt en Antiterra etíope, preludio del ave fénix
- [[Valerius_Utrecht]] — paladín portador de la espada-contenedor
- [[Labresu]] — mediador del deseo, agente del pacto
- [[Caballeros_Cicatriz_del_Sol|Cicatriz del Sol]] — orden de Valerius
...
- [[Arden_Vul|Ardisvala]] — valle de la flecha, escondite y resurgir
- [[Vala]] — mundo cuya cifra *Ardi* lo nombra
- [[Caladan]] — señor del dominio Valakhan; otra cara de la espera larga
- [[Antiterra_Demonia|Antiterra]] — escenario de la disminución preliminar al resurgir
