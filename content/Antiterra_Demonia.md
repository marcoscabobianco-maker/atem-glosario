...
epoca: "desde antes del cómputo terrestre; ciclo final consumado hacia 1901 A.D.A.; sobrevive como capa cosida a la Sinterra"
ubicacion_principal: "el otro hemisferio del par cosmológico; superficie en correspondencia con Terra pero capas subyacentes propias"
tags:
 - cosmologia
 - mundo-gemelo
 - antiterra
...
[*Los doctores antiterranos conocen la rareza simétrica: un novelista de Terra —Nabokov— escribió la crónica de un mundo gemelo y lo llamó, letra por letra, **Antiterra**; en sus páginas el nombre viejo era **Demonia**, la electricidad estaba igualmente prohibida, y el planeta hermano se llamaba Terra. Los del [[Decadiano]] discuten si fue revelación o filtración. El cruce, anota el [[Arkos|archivero del Plata]], no es decorativo. —Glosa marginal.*]

## Por qué *Demonia*

El nombre primero fue **Demonia** y **el archivero del Plata se permite anotar** que el rebautizo —*una flecha violeta en página de cuaderno, que tacha el nombre antiguo y escribe arriba* Antiterrá *con tilde, en aquel primer registro*— **no canceló la condición**. Antiterra tiene **capas ocultas que pertenecen al [[Abismo]]**: ciertos sótanos romanos, ciertas catacumbas etíopes, ciertos pozos de Lombardía conducen, si uno tiene la combinación de pasos correctos, a las profundidades de [[Azzagrat]]. Tiene **portales a [[Sigil]]**: la Plaza de la Bastilla en París, **bajo determinadas condiciones que no conviene divulgar**, abre uno. Tiene a **[[Grazzt|Graz'zt]] caminando por su historia con docena de nombres** —[[GRDT]] en Axum, **[[Grazzt|Ludovico Sforza]]** en Milán, **[[Grazzt|Jack Azul]]** en la calle de [[Catedral_de_Notre-Dame_PU|Notre Dame]], **[[Arcoms_Cosmar|Arcoms Cosmar]]** como mago lich del Séptimo Círculo en una variación que el cronista todavía no acaba de explicar—. Tiene infiernos con primeros señores —el **Primero del Primero es [[Barbatos]]**—. Tiene **un cielo donde los dioses se clavan, literalmente, sobre torres de hierro**.
...
- **Bajo el océano** corre **[[Atlantida_Alta_y_Baja|la Atlántida]]** —no la perdida, la habitada—, accesible por túneles que las flotas comerciales no marcan en sus cartas por razones que las flotas comerciales saben.
- En **cada uno de los doce sectores del zodíaco** hay **una plataforma activable**: es el **[[Juego_de_las_Sombras]]**, instalado en 1784 [[Anno_Domini_Antiterra_ADA|A.D.A.]] por agentes que ya no operan abiertamente.
- En **la costa del Mar Rojo** se levanta **[[Broken_Reach]]** como portal-fortaleza al triple reino de **[[Axum_MC|Axum]]**.
...
La **revolución libertadora de 1901 [[Anno_Domini_Antiterra_ADA|A.D.A.]]**, que cerró la dominación inglesa, dejó a Antiterra como **sociedad post-revolucionaria** de **doce avenidas dedicadas a héroes**, **panteones con estatuas sin resurrección** y **arcos de triunfo donde antes hubo coronas**.

## La iglesia

La iglesia dominante **no es** el catolicismo romano —que en Antiterra existe como secta menor, conservada en algunos cantones suizos, una franja de Irlanda y dos parroquias de Roma propia—. Es una **iglesia cristiana gnóstica sincrética**, con **vetas maniqueas, neoplatónicas y coptas**, estructura dual de *auditori* —laicos— y *electi* —ascetas—. Su cabeza es el **[[Patriarca_de_Glastumville|Patriarca de Glastumville]]**, sede asentada en una ciudad que **no figura en los mapas oficiales** pero **a la que llegan, sin equivocarse, los peregrinos que la necesitan**. La teología del Templo de **[[Pelor]]** tiene cabida en su esquema sin pedir permiso; los grandes diablos tienen **caras solares ocultas** que los curatos populares prefieren no comentar; **nadie pide que las contradicciones se resuelvan**, lo cual es prueba —según el archivero— de **madurez doctrinal**.

## Las gestas del mundo gemelo

A Antiterra el archivo no entró por tratados: entró **por bandas**. **[[Los_Boreales|Los Boreales]]** operaron desde [[Diamond_Lake]]; la **[[Jornada_Australianos|jornada australiana]]** abrió Sydney —el barrio de los alquimistas, dragones bajo autonomía parcial del Imperio— en la antesala misma de **[[Los_Profundos]]**, los anarquistas atlántidos de 1888 que abrieron el mapa de las capas; y **[[Los_Reguladores]]** cargaron con el ciclo final, hasta la Torre y la Catedral. Cada banda tiene crónica propia; esta entrada es el suelo común que las sostiene.

## El cierre

Antiterra no llega al fin de su segundo siglo. Hacia **1901 A.D.A.**, el mundo gemelo se aproxima a la **[[Franja_de_la_Disolucion|franja de disolución]]** —línea cosmológica donde un mundo deja de poder sostenerse contra su gemelo—. **La destrucción se ve venir desde lejos**: hay quienes la saben con precisión —**[[Pablo_de_Alejandria|Paulus]]** mismo, los **[[Los_Reguladores|Reguladores]]**, el **[[Cakravartin]]** desde la [[Atlantida_Alta_y_Baja|Atlántida]]—; hay quienes sólo perciben **el aire enrarecido** y atribuyen la sensación al clima. **Es el arco final del ciclo**: el **[[Torneo_de_la_Torre_Eiffel|Torneo de la Torre Eiffel]]**, el **ataque a [[Catedral_de_Notre-Dame_PU|Notre Dame]]**, la **caída de [[Barbatos]]** en el umbral mismo del colapso, el **clavado de [[Seth]] por [[Faragod]]** sobre la Torre. **Antiterra se quema entera en sus últimas estaciones.** El cronista, *que asistió en figura literaria y murió en el archivo bajo el nombre [[Pablo_de_Alejandria|Paul Claudel]], lo cual le da una autoridad que no es enteramente teórica*, no se extiende.

Lo que viene después no es la muerte limpia del mundo gemelo: es **[[Sinterra]]** —**la síntesis**—. **[[Paris_Ucronica|París Ucrónica]]**, con sus iglesias convertidas en bibliotecas por **decisión de Pablo**, queda como **la membrana donde Terra y Antiterra se cosen por última vez**. *La ucronía no es alivio: es cicatriz.*

---

## Lo que el cierre no cierra

**El fin de Antiterra no es el fin de [[Grazzt|Graz'zt]].** La doctrina apresurada lo dio por amortizado: disminuido por [[Maleika_Maleyka]], descabezado por la espada de [[Faragod]], expulsado del concilio, vencido en [[Catedral_de_Notre-Dame_PU|Notre Dame]]. *La doctrina apresurada se equivocó dos veces en una sola era.*

Mientras los [[Los_Reguladores|Reguladores]] libraban la última batalla en la Torre y la Catedral, **el príncipe demoníaco preparaba la escena siguiente**. **No para Antiterra.** Para el otro hemisferio del par, **para el mundo de [[Vala]]**. Para el valle cuyo nombre conserva la cifra antigua: **[[Arden_Vul|Ardi]]** —*lugar donde la flecha cae, donde se decide*—.

Allí, en la matriz de aquel valle, **Graz'zt se escondió a sí mismo en forma proto** —**[[Ardipithecus]]**, el ancestro abismal anterior a la diferencia hombre-demonio—. **Eligió crisálida.** Esperó. *Esperó.*
...
[*El ave fénix de Graz'zt es leitmotiv que el cronista descubre tarde y anota como debió haberlo anotado siempre. La disminución de Antiterra fue preludio operístico, no cierre. —Glosa marginal del [[Arkos|archivero del Plata]].*]
...
- [[Franja_de_la_Disolucion|Franja de Disolución]] — el límite que la consume en 1901
- [[Anno_Domini_Antiterra_ADA|A.D.A.]] — su calendario propio
- [[Paris_Ucronica|París Ucrónica]] — su capital virreinal en el ciclo final
- [[Lord_Gaul]] — virrey ucrónico de la última era
- [[Los_Reguladores|Reguladores]] — héroes del ciclo final
- [[Atlantida_Alta_y_Baja|Atlántida]] — la capa subacuática permanente
- [[Cakravartin]] — Rey atlante
- [[Juego_de_las_Sombras]] — el mecanismo cosmológico de las plataformas
- [[Grazzt|Graz'zt]] — presencia constante bajo múltiples nombres; ave fénix que el cierre antiterrano no cancela
- [[Ardipithecus]] — forma proto en la que Graz'zt se guardó para el ciclo siguiente
- [[Maleika_Maleyka]] — la que disminuyó al demonio en Antiterra etíope; preludio del escondite cosmológico
...
- [[Barbatos]] — [[Barbatos|Primer Señor del Primer Infierno]]
- [[Pablo_de_Alejandria|Paulus]] — cuidador de bibliotecas post-1901
- [[Broken_Reach]] — fortaleza-portal en Mar Rojo
- [[Sigil]] — ciudad-cruce planar accesible
- [[Abismo]] — capa infernal subyacente
- [[Patriarca_de_Glastumville|Patriarca de Glastumville]] — cabeza de la iglesia gnóstica
