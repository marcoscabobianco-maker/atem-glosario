...
ubicacion_principal: "Caldero; Bastardo Cromas (habitación principal compartida con Teo)"
tags:
 - personaje
 - jabalina
 - caballero
...
*Lucky opera con conciencia parcial de su linaje* —*"se rumorea... aunque pocos se arriesgan a que cuente más"*—; **conciencia controlada y discreta**. *La discreción no es accidente*; **es disciplina del avatar** *que entiende que nombrarse plenamente desestabilizaría su operación en Caldero*.

---

## La doble doctrina: paladín + arcana

**Lucky combina la nobleza de un paladín con la sutileza de la magia arcana**. **Sus golpes imbuidos de poder divino** son **los tremendos smites** —*conjuros sagrados que el paladín de la Sagrada Orden carga en arma y descarga en enemigo*—. *Lo distintivo de Lucky*: **no opera sólo con smites; opera con magia arcana adicional**. **Combinación rara en la doctrina paladinesca clásica**, *que tradicionalmente confina al paladín al canal divino*.
...
*Lucky no explica el origen de su magia arcana*. **La opera**.
...
[*Lucky lleva el nombre que el cosmos le permite llevar mientras opera. Cuando el cosmos requiera que diga su nombre real, lo dirá. Hasta entonces, Lucky basta. La operación cosmológica no necesita nombre completo para operar; necesita el oficio del caballero. Lucky cumple el oficio. —Glosa de [[Arkos]] el archivero del Plata.*]
...
- [[Arian|el avatar arlequín]] — tercer avatar paralelo (Foso)
- [[Caladan]] — cuarto avatar paralelo (Valakhan)
- [[Teo_Paladin_Sin_Brazo]] — compañero de habitación, paladín mutilado
- [[Bastardo_Cromas]] — sede operativa
- [[Templo_de_San_Cutberto]] — institución doctrinal con tensión sutil
- [[Cageewrights]] — profecía cosmológica de contrabalanceo posible
- [[Capitan_Skellerang]] — financiador
- [[Reina_Goblin]] — adversario de combate documentado
- [[Vampiro_Bugbear]] — adversario de combate documentado

## Apariciones

- **Formación de La Jabalina** — miembro
- **Combate contra vampiro bugbear en sala festiva** — smite celestial documentado en prensa
- **Otras misiones del grupo** — operaciones cargadas paladinescamente
