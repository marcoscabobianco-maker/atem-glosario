...
1. **Exterminar a los [[Halflings_Plumthorn|Halflings de Plumthorn]]** — recién llegados, ofensa territorial
2. **Mantener alianza con [[Kerbog_Khan]]** — autómatas a cambio de mano de obra y ácido
3. **Expandirse demográficamente** — los goblins se reproducen rápido
4. **Sobrevivir al Vencimiento de los [[Varumani]]** — pre-hiato eran vecinos; post-hiato vacuum
5. **Resistir al avance del [[Papa_Alejandro_Sixto]]** — si el papado intenta centralizar

### Sus aliados

| Aliado | Tipo |
|---|---|
| **[[Kerbog_Khan]]** | Comercio de autómatas vs. ácido / mano de obra (P) |
| **Killik** | Sub-jefe goblin "big boss of the wet caves" |
| **Goblin sub-chiefs** | Estructura militar interna |
...
- **Goblin sub-chiefs** — de talla y fiereza de hobgoblin 
- **Goblins regulares** — la masa del reino
- **Goblin emissaries** —enviados a otras facciones (visitas al [[Forum_de_Set]], etc.)
- **Goblin shamans / clerics** —posibles
