...
aliases:
 ...
 - El subsuelo de Kazmojen
 - La sub-estructura sagrada del cráter
categoria_diegetica: lugar
epoca: "fortaleza antigua, anterior al cómputo conocido; sub-señorío activo bajo Caldero en el ciclo presente"
ubicacion_principal: "bajo Caldero, accesible por pozo octogonal desde la Calle de la Linterna; conexión con Jzadirune por puertas de engranajes"
tags:
 - lugar
 - subsuelo
 - fortaleza
...
*A los lados del pasillo principal*: **jaulas vacías colgaban de cadenas**, *vestigio de los escarabajos de fuego que una vez iluminaron estas profundidades*. **Hoy queda la promesa de peligro**. *Las jaulas crujen ligeramente con corrientes de aire que el sub-señorío no controla*.
...
*Adyacente al pasillo*: **ogro desgarbado y maloliente** *con martillo cubierto de inmundicia* —*"Más carne para mi despensa. Qué amables"*— **emerge al sonido del combate**. *Adversario derrotado por la coordinación del grupo*.
...
**Bajo el mando de Kazmojen**:

- **Hobgoblins** *como guardia armada*
- **Esclavistas** *coordinadores del comercio clandestino*
- **El [[Howler]]** *como mascota personal*
- **Enanos grotescos** *como intermediarios diplomáticos*
- **Skulks** *como criaturas de vigilancia oculta* —*"figura oculta hasta entonces, saltó desde las sombras del piso superior, moviéndose con rapidez y letalidad"*—

*Criaturas residuales del sub-señorío* **que el sub-mundo conserva sin mando central** tras la derrota de Kazmojen.
...
- [[Howler]] — mascota troll-bestia
- [[Bazar_de_la_Vida]] — operación clandestina principal
- [[Zenith_Splintershield]] — estatua de defensor enano legendario
- [[Camara_de_las_Mascaras_Susurrantes]] — cámara de descanso
- [[Jzadirune]] — enclave gnómico conectado
- [[Capilla_Oscura]] — sub-estructura sellada cercana
- [[Keygan_Ghelve]] — cerrajero cuyas llaves abren las puertas de engranajes
- [[Skulk]] — criatura del subsuelo
- [[Subóscuro]] — geografía cosmológica de donde provienen los esclavistas
- [[La_Jabalina]] — grupo que penetró la Fortaleza
...
- **Post-derrota** — vacante; destino no fijado
