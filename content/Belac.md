...
**Belac** —*Belac the Outcast* en la tradición de la Ciudadela— es el **druida proscrito custodio terrenal del [[Arbol_Gulthias|Árbol Gulthias]]** en la **[[Ciudadela_Hundida|Ciudadela hundida]]**. El archivo lo conservó **casi igual** en su versión de Valachhan: *"Belac (se mantiene casi igual, suena rumano). El druida del Árbol."*

(Posible dictado: **"Novelac"** en el archivo oral puede ser **Belac** con prefijo de voz).

### Su rol

**Druida humano de oficio probado**:

- Más sabio que fuerte; de cuerpo común y entendimiento agudo
- Aguanta más castigo del que su figura sugiere
...
- **Conversor**: puede ofrecer corrupción druídica a compañeros druídicos (cf. [[Numa_Pompidio]] paralelo en [[Ardis_Vala]] — el primer druida convertido en vampiro)
