...
epoca: "atestado en el episodio constantinopolitano de Olaus Wormius; recurso recurrente del archivo cronomántico"
ubicacion_principal: "donde el receptor abra el sobre — geografía secundaria"
tags:
 - cronomancia
 - carta
 - viaje-temporal
...
La mano del joven **[[Olaus_Wormius_aka_Theodorus|Olaus Wormius]]** descansa al lado del pliego, *recién apartada de la lectura*. Su expresión es la de **quien reconoce, por primera vez, su propia letra en el papel que recibe**. Detrás, **calavera sobre estante**, **libros abiertos**, **vitral con escudo familiar**, **astrolabio**.

---

## El procedimiento cronomántico

Las cartas a uno mismo no se escriben con tinta sola. **Requieren mediación de las artes del tiempo** —*procedimiento que el archivo no transcribe entero por la regla decadiana de no enseñar lo prohibido en cuerpo público*—. El emisor escribe en un instante; el receptor recibe en otro. **El emisor y el receptor son la misma persona en líneas de vida distintas**.
...
- [[Olaus_Wormius_aka_Theodorus|Olaus Wormius]] — el receptor y emisor único de la carta documentada
- [[Constantinopla_Ucronica_1055_CE|Constantinopla 1055]] — escenario probable de la recepción
- [[Hilo_Dorado_Sucronico|Hilo Dorado Sucrónico]] — artefacto afín del procedimiento cronomántico
- [[Ripple_Effect|La cascada del tiempo]] — efecto colateral del viaje temporal mal calculado
- [[Pablo_de_Alejandria|Paulus]] — cronista que, sin haberse escrito carta a sí mismo, podría hacerlo
