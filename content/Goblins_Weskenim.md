...
| Vínculo | Facción |
|---|---|
| **Aliados primarios (P)** | **[[Kerbog_Khan]]** — autómatas dragonfly a cambio de mano de obra y ácido goblin |
...
Los Goblins son **la facción más demográficamente expansiva** del dungeon —no la más poderosa, pero **se multiplican rápido**—. **Buscan aliados activamente** para sus conflictos: ofrecen alianza a los compañeros si éstos prometen ayudar contra los halflings de Plumthorn.

**Su alianza con [[Kerbog_Khan]]** los hace **anómalos**: son la única facción "tradicionalmente humanoide" del dungeon **integrada** con la **tecnología rudishva** (vía Kerbog Khan).
