...
aliases:
 ...
 - "Valle de la Muerte (Constantinopla"
 - "Anatolia)"
 - "Constantinopla"
 - "Anatolia"
 - "Valle de la Muerte"
...
**Ocupación hostil:** [[Little_Death_Campamento|Campamento]] de conjuradores/brujos que profanan el valle. Construyen "ejército de piedra y almas" usando el líquido marmóreo. Emplean hordas de criaturas (gigantes, scouting parties). Los líderes permanecen en la retaguardia/base mientras envían hordas contra objetivos como el reino de la [[Dama_Amarilla_Senora_del_Oasis|Dama Amarilla]].

## Apariciones notables

[[Paris_Ucronica|París Ucrónica]]: primera llegada, combate contra serpiente voladora, campamento nocturno, encuentro con [[Madre_Grima_Grima-Luna_Madre_Luna_Grima|Madre Grima]]. Jornada posterior: exploración de la torre no-euclidiana (ángulos que desafían geometría normal, gravedad invertida, 6 salidas incluyendo acantilado). Torre contaminada con esporas fúngicas que modifican comportamiento (metáfora de toxoplasmosis). [[Little_Death_Campamento|Campamento]] de 4 mercenarios contaminados (codificados por color). Encuentro con [[Ronian]] (mercader bibliofágico), [[Marques_de_Sade_Hugo|Marqués de Sade]]/[[Marques_de_Sade_Hugo|Hugo]] (viajero temporal), ejecución de [[Eurodico]] (cuarto general). Combate extendido contra osfiotauro (toro-serpiente). [[Philippe]] muere/queda críticamente herido. Torre alineada con [[Aldebaran_Estrella_Plataforma|Aldebarán]]. Ejército de gigantes y orcos aproximándose al Pueblo Amarillo. Jornada posterior revela que gran parte de los eventos previos ocurrían dentro de un Mindscape (alucinación inducida por esporas). Jornadas 13-16: exploración de la pirámide y laberinto subterráneo.

## Notas

El Valle funciona como dungeon abierto: zona de exploración con múltiples peligros, misterios y accesos. La "ciudad que se despierta" es una referencia a construcciones subterráneas habitadas por seres hostiles. El liquid marmóreo recuerda al visto en la corte de la [[Dama_Amarilla_Senora_del_Oasis|Dama Amarilla]]. La contaminación por esporas introduce un nivel de unreliable narration: lo que los compañeros perciben puede no ser real. Ver también **[[Madre_Grima_Grima-Luna_Madre_Luna_Grima|Madre Grima]]**, **[[Dama_Amarilla_Senora_del_Oasis|Dama Amarilla]]**, **[[Serpiente_Voladora_del_Valle|Serpiente Voladora del Valle]]**, **[[Ronian]]**, **[[Marques_de_Sade_Hugo|Marqués de Sade]] / [[Marques_de_Sade_Hugo|Hugo]]**, **[[Osfiotauro]]**, **[[Eurodico]]**.
