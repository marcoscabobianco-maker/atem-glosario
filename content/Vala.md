...
aliases:
 ...
 - Vala (mundo)
 - El Mundo Vala
 - El Mundo de las Tres Fases
categoria_diegetica: lugar
epoca: "anterior al cómputo conocido; tres fases sucesivas, la última en curso"
ubicacion_principal: "continuum cosmológico propio, distinto de Terra y de Antiterra; comparte matriz con Vala Cristalis"
tags:
 - cosmologia
 - mundo
 - vala
...
## Ardis, o el lugar de la flecha

El sufijo **Ardis** —que da nombre a la fase actual, **[[Arden_Vul|Ardisvala]]**— **no es invención del archivo presente**. Lo conserva el **Libro de los Vigilantes**, sección menor del *[[Libro_de_Enoch|Libro de Enoc]]*: **Ardīs** —*el monte donde los Vigilantes descendieron a tomar mujer y enseñar artes prohibidas*—. La etimología más antigua lo traduce como **"lugar de la flecha"**: punto en el que la flecha cae, que es donde se decide.
...
## Los ciclos que llevan al valle

Vala no aparece de la nada. La precede una cadena de destrucciones cuyo recordatorio conviene tener cerca:

- **Primero**, **[[Angara_Andgara|Angara]]** —el continente del primer cosmos—. Se quebró en la **primera Grieta**. De ahí salieron, exilados, los que fundaron el Panteón inicial: [[Arian]] entre ellos.
- **Después**, **[[Antiterra_Demonia|Antiterra]]** —el mundo gemelo que la cosmología decimonónica recibió como herencia—. Sostiene su ciclo entre 1715 y 1901 [[Anno_Domini_Antiterra_ADA|A.D.A.]].
- **Después**, el **fin de Antiterra** y el descenso a la **[[Franja_de_Disolucion|Franja de la Disolución]]**: el mundo que se queda sin sostén ontológico.
- **Después** —o paralelo, según el doctrinario al que se le pregunte—, la **Ucronía**: rama que ramifica el cierre y produce nuevos cosmos, **[[Ucronica_NC_Northern_Crown|NC]]** entre ellos.
...
- [[Vala_Antigua]] — fase primera; cosmología pre-Grieta
...
- [[Valakhan_de_la_Bruma|Valakhan]] — dominio brumoso de la fase actual
- [[Papa_Alejandro_Sixto|Papa Alejandro VI]] — autoridad eclesial de la fase actual
- [[Pablo_de_Alejandria|Pablo de Torregrises]] — cronista paralelo que diferencia los mundos
