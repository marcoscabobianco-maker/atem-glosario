...
aliases:
 - Antonio
 - Antonio de La Jabalina
categoria_diegetica: personaje
epoca: "activo en el ciclo presente (1824 AE); nombrado en la convocatoria inicial de Jenya Urikas"
ubicacion_principal: "Caldero, en operaciones con La Jabalina; procedencia no preservada en archivo accesible"
tags:
 - personaje
 - jabalina-convocatoria
 - aliado-diversa-procedencia
 - mencion-mascor
...
**Antonio** aparece en el compilado de [[Mascor_Blancarba|Mascor Blancarba]] **nombrado en la convocatoria solemne** que [[Jenya_Urikas|la sacerdotisa Jenya Urikas]] dirigió en el [[Templo_de_San_Cutberto|Templo de San Cutberto]]. **Junto a [[Lukas]], [[Fogimer|Foggimer]], [[Scylla|Sila]] y otros aliados de diversas procedencias**, Antonio fue convocado para integrar **el grupo que después se llamaría [[La_Jabalina]]**.

*El compilado no expande la procedencia, la apariencia, los conjuros o el oficio de Antonio en esta cita*. **Es figura nombrada sin desarrollo textual mayor** en el archivo accesible al cronista presente.

---

## El estado del archivo *(voz Paulus)*
...
[*Cuando una figura aparece en un compilado con nombre pero sin tratamiento, lo prudente es no inventar la voz. Antonio existe en el archivo; existirá en el archivo expandido cuando el material lo permita. Por ahora, el nombre basta para mantener el wikilink operativo. —Glosa de [[Arkos]] el archivero del Plata.*]

---

## Vínculos

- [[La_Jabalina]] — grupo convocado
- [[Jenya_Urikas]] — sacerdotisa convocante
- [[Templo_de_San_Cutberto]] — locus de la convocatoria
- [[Mascor_Blancarba]] — cronista que registra la mención
- [[Lukas]] · [[Fogimer]] · [[Scylla]] — co-convocados en la misma reunión
