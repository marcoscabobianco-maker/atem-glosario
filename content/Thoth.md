...
## La estética de la cabeza de garza *(voz Paulus)*

**Los sacerdotes de Thoth** —**[[Custodes_Oculis_Solis|los Custodes Oculis Solis]]**— **llevan en la cabeza el emblema de la garza** *como signo doctrinal*. *No es máscara*: **es transmutación ritual** *que el aparato eclesial sostiene durante el oficio*. **Quien ve a un Custode con cabeza de garza** *no ve a un humano disfrazado*; **ve a la operación del dios manifestándose en cuerpo humano**.

*La doctrina interna del aparato*: **la garza es ave de la orilla**, **opera entre el agua y la tierra**; **conoce los dos elementos sin pertenecer plenamente a ninguno**. **Como la garza**, *el escriba de Thoth* **opera entre el habla y el archivo**, **entre la operación viva y la doctrina conservada**. **Sin habitar plenamente ninguno**.
...
## Los manuscritos dispersos

**Los manuscritos de Thoth circulan dispersos** en el archivo cosmológico del ciclo presente:

- **[[Argus_PJ]]** —*guerrero curtido, georgiano del Cáucaso, miembro de los nuevos compañeros de los [[Buscadores_de_Ardis_Vala|Buscadores]] post-Hiato*— **porta manuscritos de Thoth**, *obtenidos tras la muerte de [[Numa_Pompidio]] en el templo*. **Su revelación posterior** *(paradigma caído, [[Ardipithecus]], ancestro primigenio)* **opera adyacente a los manuscritos que lleva**.
- **Manuscritos privados de [[Casa_Azul_de_Vala]]** *que conservan fragmentos del archivo imperial pre-Cisma*.
- **Manuscritos clandestinos teósofos y sortianos** *que retuvieron porciones del archivo durante la guerra civil*.

*El cosmos extendido conserva la doctrina de Thoth* **en transmisión fragmentaria**. **Quien quiera operar con el dios escriba** *en el ciclo presente* **debe triangular entre manuscritos dispersos**, *sin esperar que el aparato eclesial provea acceso unificado*.

---

## La función estructural

[*Thoth es lo que el cosmos extendido necesita cuando el archivo amenaza con perderse. Donde aparece el dios escriba, aparece la conservación; donde aparece la conservación, aparece la doctrina; donde aparece la doctrina, el orden imperial puede sostenerse o no, pero el archivo persiste. La asimilación papal del aparato de Thoth no consumó al dios: lo redirigió. La diferencia importa. —Glosa de [[Arkos]] el archivero del Plata.*]
...
- [[Argus_PJ]] — portador de manuscritos en el ciclo presente
- [[Numa_Pompidio]] — primer druida muerto en el templo de Thoth
- [[Oborus]] · [[Lysis]] · [[Tod_Set]] — co-dioses del panteón imperial
- [[Gran_Cisma_Magico]] — guerra civil que fragmentó el archivo
- [[Teosofos]] · [[Sortianos]] — facciones que retuvieron fragmentos
- [[Casa_Azul_de_Vala]] — linaje cuyos archivos privados conservan material
