...
aliases:
 ...
 - Casas Mercantes Imperiales
 - Mercaderes Factoriales del Imperio
 - Casa Glesteon
categoria_diegetica: facción
epoca: "cuerpo comercial imperial archonteo; operación sostenida a través de varios reinados; activos en el ciclo presente"
ubicacion_principal: "Glastumville (sede principal); rutas comerciales del valle del Barrado Balacán; sede antigua en Ritornello destruida"
tags:
 - faccion
 - mercaderes
 - imperial
...
## El cuerpo comercial oficial *(voz Mascor Blancarba)*

**Los Mercaderes Factoriales** —*"Casas Mercantes Imperiales"* en grafía formal del aparato decadiano archonteo, *"los Factoriales"* en boca corriente del valle, *"Casa Glesteon"* en la línea de la familia mayor— **son el cuerpo comercial oficial del aparato imperial archonteo** *operando en el valle del [[Barrado_Balacan|Barrado Balacán]]*. **Su oficio**: **comercio sancionado, tarifas imperiales, rutas oficiales, depósitos protegidos por la [[Fortaleza_Azur|Fortaleza Azur]]**.

*El contraste con la rival [[Hermandad_Benevola]]*:

| Aspecto | Mercaderes Factoriales | Hermandad Benévola |
|---|---|---|
| Estatus | Oficial imperial | Clandestino tolerado |
...
**Los Factoriales operan con doctrina específica**:
...
- [[Theron_Glesteon]] — cabeza visible en el ciclo presente
- [[Glastumville]] — sede actual de operaciones
- [[Ritornello]] — sede antigua destruida
- [[El_Huevo_de_Ritornelo]] — instrumento de la destrucción de la sede antigua
- [[Hermandad_Benevola]] — facción rival clandestina tolerada
- [[Fortaleza_Azur]] — ciudadela que custodia depósitos
- [[Eusebia_Phokas]] — figura imperial coordinadora
- [[Barrado_Balacan]] — geografía operativa
- [[Iglesia_Imperial]] — aparato eclesial superior
- [[Drusus_IX_El_Palido]] — emperador cuyo aparato sostiene el cuerpo Factorial

## Apariciones

- **Fase imperial archontea sostenida** — operación comercial oficial continuada
- **Sede comercial en Ritornello** — fase de mayor expansión pre-caída
- **Caída de Ritornello** — pérdida mayor del aparato Factorial
- **Reorganización hacia Glastumville** — Theron Glesteon asume la dirección post-catástrofe
- **Ciclo presente** — operación activa bajo subvención imperial de reorganización
