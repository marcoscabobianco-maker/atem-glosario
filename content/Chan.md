...
**Chan** es **una de las cuatro miembros principales de [[Las_Tullidas]]** —el grupo aventurero de señoritas mutiladas mágicamente por Papi [[Balor]]—. Su naturaleza compuesta la define: **mujer dragón**, con un **brazo transformado en una serpiente sentiente** —no extremidad pasiva, sino criatura propia con voluntad parcial, atada al cuerpo de Chan pero con boca, ojos y, presumiblemente, lengua propia—.
...
- [[Luquimia]], [[Liddha]], [[Monaco|Mónaco]] — co-tullidas
- [[Mina]] — aliada del grupo
- [[Hannok]] — compañero del grupo
- Papi [[Balor]] — torturador / progenitor mágico
- [[Taberna_de_la_Serpiente_Mundo|Taberna de la Serpiente Mundo]] — base operativa (resonancia con su naturaleza serpentina)
- [[Grazzt|Graz'zt]] — empleador en la última misión
- [[Amuleto_de_los_Planos]] — objetivo de la última misión
- **Dragones** en general — su línea de naturaleza
- **Brazo-serpiente** — su extremidad sentiente
