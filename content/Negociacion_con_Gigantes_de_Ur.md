...
**Participantes:** [[Hugo_de_Payns|Hugo de Payns]], grupo compañeros, gigantes de Ur.
...
| T+24h | Investigación de cripta, descubrimiento del robo de armadura |
| T+36h | Incidente nocturno: ataque en cripta, muerte de [[Alexio]] |
| T+48h | [[Entierro_de_Alexio|Entierro de Alexio]] en mezquita |
| T+72h | Negociación con gigantes de Ur, depósito de reliquias |
| T+84h | Cierre de la jornada, grupo en incertidumbre |

## Cambios narrativos tras el robo de reliquias

1. **[[Arsvan|Ärsvan]] separado del grupo** (ubicación: campamento enemigo "[[Campamento_de_Turcos_del_otro_lado_del_Jordan|del otro lado del Jordán]]").
2. **[[Alexio]] muerto** (imposible participación en jornadas siguientes salvo resurrección).
3. **[[Elizabeth_de_Beauvois|Elizabeth de Beauvois]] introducida** como figura de poder rival/complementaria a [[Marques_de_Sade_Hugo|Hugo]].
