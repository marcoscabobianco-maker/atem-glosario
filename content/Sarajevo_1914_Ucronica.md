...
aliases:
 - Sarajevo
 - Sarajevo 1914
 - el atentado del Puente Latino
 - Día de San Vito (1914)
categoria_diegetica: evento
epoca: "28 de junio de 1914 — Belle Époque uchrónica en cierre"
ubicacion_principal: "Sarajevo bosníaca — Puente Latino, fábrica de tabaco, ruta de desfile imperial"
tags:
 - evento
 - paris-ucronica
 - atentado
...
> *"Let me go… let's meet in the past."* — Sophie, último parlamento documentado.

**La escena entera comprimida en un instante anterior al disparo**: a la izquierda, **un carruaje descubierto avanza sobre el adoquinado** —*figuras femeninas con sombrero, oficial uniformado al lado*—, **el caballo todavía calmo**; al centro del cuadro, **un joven de levita oscura con rosa roja en el ojal** —Gavrilo o el cuerpo que opera bajo Gavrilo— **mira pasar el carruaje sin mover un músculo**; a la derecha, **dos oficiales austro-húngaros de uniforme blanco con condecoraciones plenas** observan la escena sin sospechar todavía. **En el balcón superior**, *tres testigos asoman la cara*: una mujer con sombrero ancho, un hombre con anteojos, una sombra al fondo. **El minarete y la cúpula del fondo** marcan la geografía bosniaca; **el Puente Latino cruza al fondo izquierdo** con sus arcos viejos.
...
**La cuenta exacta del día**, **según la cronomancia y la prensa común coinciden**, **es ésta**:

1. **La bomba lanzada por el primer conspirador falla** —rebota sobre el carruaje y estalla atrás—.
...
**El asesinato detona la Primera Guerra Mundial** en la historia común y en la uchrónica simultáneamente. *El imperio austro-húngaro declara guerra a Serbia; el sistema de alianzas se activa; el siglo XIX se acaba en julio de 1914*. **Lo que la cronomancia añade —y aquí el archivero del Plata anota la diferencia mayor— es que el cuerpo del joven que dispara queda registrado dos veces**: una en la fotografía del expediente austríaco bajo el nombre de Gavrilo, **otra en el archivo akásico bajo el nombre de Claude**.

[*"Hay disparos que cambian un siglo; hay disparos que cambian dos. El del Puente Latino fue el segundo tipo, lo cual es muy raro y, conviene anotarlo, no agradable para nadie en particular." — Glosa atribuida al libro V del [[Decadiano]].*]

## Vínculos

- [[Gavrilo_Princip]] — el cuerpo que ejecuta, doblado por Claude
- [[Cvjetko_Popovic]] — la identidad asumida por Claude
- [[Archiduque_Francisco_Fernando]] — víctima principal
- [[Duquesa_Sophie_de_Hohenberg]] — víctima secundaria, parlamento cardinal
- [[Mano_Negra_Antiterra_Serbia]] — organización que sembró la fecha
- [[Black_George]] — comandante de la mesa de planificación
- [[Batalla_de_Kosovo_1389]] — cruce cronomántico exacto del 28 de junio
- [[Time_Bandits]] — el grupo proyectado como Guardias Ucrónicos
- [[Guardias_Ucronicos]] — figura cronomántica del rol forzado
- [[Circulo_Simultaneo]] — el cuerpo que los proyecta
- [[Moni_Vivescu]] — quien advierte de la fecha por bola de cristal
- [[Vito_Guia|San Vito]] — santo del día, marca cronomántica
- [[Akala]]
