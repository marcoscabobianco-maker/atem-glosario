...
El nombre de la campaña ("Rol de la Hostia") y del dungeon ("Dungeon de la Hostia") giran alrededor de este artefacto. En la fase de cierre, [[Gideon]] porta la última Hostia para la plataforma de Virgo. El **[[Poker_de_Hostias|Poker de Hostias]]** (evento clave en París) es un ritual de juego de cartas donde las Hostias se utilizan como apuestas cósmicas.
