---
tags: [SaintGermain, MMF, 1648, Francia, lugar, kanka-5212907]
meta: M
image: _assets/SaintGermain/ATEM__SaintGermain__MMF__Feudo_de_Don_Guifré_retrato.png
image_status: pending
nexus_status: APPROVED
---

# ATEM::SaintGermain::MMF::Feudo de Don Guifré

> [!image-pending] Generar imagen
> **Slot:** `_assets/SaintGermain/ATEM__SaintGermain__MMF__Feudo_de_Don_Guifré_retrato.png`
> **Prompt sugerido:** Ilustración de ATEM::SaintGermain::MMF::Feudo de Don Guifré. Estilo coherente con la campaña.
> **Notas:** Reemplazar wikilink de abajo cuando este la imagen.

![[ATEM__SaintGermain__MMF__Feudo_de_Don_Guifré_retrato.png]]


**status:** PROPUESTO — requires_user_review
**namespace:** ATEM::SaintGermain::MMF
**kanka_id:** 5212907
**kanka_url:** https://app.kanka.io/w/216093/entities/5212907
**kanka_kind:** location
**kanka_type:** (vacío)
**parent_location:** Provence (kanka 5211443)

## Resumen de aparición en transcripts MMF

- **Hits totales** (todas las sesiones): 16
