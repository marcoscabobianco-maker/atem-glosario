...
aliases:
 - Gemelos Inquisidores
 - Los gemelos
 - Lucio y Luke
 - Lucio Bermond
 - Luke
 - Los hermanos guardias
categoria_diegetica: personaje
epoca: "introducidos en el ciclo presente como guardias del Abad; perdonados al calabozo tras la jornada del altar"
ubicacion_principal: "monasterio de Helix; calabozo eclesial tras la jornada"
tags:
 - personaje
 - hermanos
 - gemelos
 - guardias-inquisicion
 - escuderos-caidos
 - mercenarios
 - helix
 - corrompidos
...
*El cronista anota la panoplia con detalle no por gusto enciclopédico, sino porque* **la armadura, el hacha, los jinetes y el oro** fueron precisamente las **ofertas que el demonio [[Quasi_demonio_menor|Quasi]] usó para tentar al primer gemelo**. *El catálogo del pacto se calzaba sobre el equipo del cuerpo*.

## La fuga

En la noche sin luna, en el monasterio de Helix, **el primer gemelo cedió a la tentación de Quasi** —*tras ofertas escaladas de armadura, hacha terminal, jinetes (Barbulis), castillo, y diez mil monedas de oro escondidas cerca del barro*—. **Abrió la celda del brujo [[Silas_del_Umbral|Silas]]** y escapó con él. *El segundo gemelo lo siguió*. Salieron asistidos por un **tragoide** (homúnculo subalterno) que llevó los caballos.
...
Cuando los gemelos volvieron a [[Helix]] **al borde del cerco esquelético** —escoltando a Silas que pedía la [[Tableta_del_Caos]] desde el altar—, **entraron a la [[Iglesia_Consagrada_Helix|iglesia consagrada]]** (los humanos en estado de corrupción pueden cruzar el umbral; los muertos vivientes mayores no).
