...
aliases:
 ...
 - Los Amantes y la Serpiente
 - Ishen y Nalía
 - El cántico del espejo de plata
categoria_diegetica: mito
epoca: "mito fundacional del mundo-gema; conservado en el compilado de Mascor Blancarba"
ubicacion_principal: "Vala Cristalis; sellado ritual en la Capilla de la Redención de Caldero"
tags:
 - mito
 - fundacional
 - amantes
...
**Dos seres destinados a unirse para sellar un pacto entre la luz del Sol y el reflejo de la Luna**: **Ishen**, el novio solar; **Nalía**, la novia lunar. *El cosmos primigenio del mundo-gema requería el sellado*: sin la unión, la luz diurna y el reflejo nocturno no entrarían en el equilibrio rítmico que sostiene los ciclos del [[Vala_Cristalis|mundo-gema]].

Pero **la [[Serpiente_Luna_Auna|Serpiente de la Medianoche]]** —*manifestación específica de Auna en el momento del pacto*— **reclamaba un tributo para permitir la unión**. *La doctrina serpentina*: ningún pacto entre opuestos opera sin que el orden serpentino cobre su parte. *Una vez tasada la parte, la unión puede consumarse; antes, no*.
...
- [[Serpiente_Luna_Auna]] — figura mítica del pacto
- [[Capilla_de_la_Redencion]] — locus del sellado
- [[Vala_Cristalis]] — mundo-gema en cuya capa primigenia opera el mito
- [[Aguila_Asvila]] — figura solar complementaria
- [[Casa_Azul_de_Vala]] — linaje cuya doctrina conserva la lectura cristalina
- [[Mascor_Blancarba]] — cronista que compila el mito
- [[Mitos_Fundacionales_de_Caldero]] — corpus al que pertenece
- **Espejo de plata** — interfaz ritual del pacto
