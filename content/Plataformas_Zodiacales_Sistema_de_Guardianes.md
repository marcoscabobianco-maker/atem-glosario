...
aliases:
 - Plataformas Zodiacales / Sistema de Guardianes
 - Plataformas Zodiacales
 - Sistema de Guardianes
 - Las Doce Plataformas
 - Sistema zodiacal cósmico
categoria_diegetica: concepto
epoca: "cosmología continua; doctrina primigenia documentada desde 1995"
ubicacion_principal: "cosmos extendido — sistema de doce plataformas suspendidas en el continuo zodiacal"
tags:
 - concepto
 - cosmologia
 - sistema-zodiacal
...
**La plataforma es la prisión del guardián**: *el guardián no podría salir de su signo aunque quisiera*, **está atado a la columna del cargo por la condición misma del oficio**.

---

## La Corrupción Dual

**La ley operativa del sistema** se llama **[[Corrupcion_Dual|Corrupción Dual]]**: *quien mata al guardián zodiacal se convierte en guardián o es destruido*. **Ningún hueco queda abierto**: *el guardián cambia*, *la columna no*. **El cargo rota; la doctrina del signo permanece**.

*Esta ley explica por qué las plataformas conservan continuidad operativa a través de eras*: **los guardianes mortales rotan**, *pero el concepto que cada plataforma sostiene* —**violencia, fuerza, dualidad, etc.**— **persiste invariable**.
...
| 9 | **[[Plataforma_Sagitario]]** | ♐ Sagitario | flecha hacia lo invisible | el centauro arquero *(sin nombre canónico)* |
| 10 | **[[Plataforma_Capricornio]]** | ♑ Capricornio | ascenso volcánico-serpentino | la cabra-serpiente *(sin nombre canónico)* |
| 11 | **[[Plataforma_Acuario]]** | ♒ Acuario | don al vacío | el aguador *(sin nombre canónico)* |
| 12 | **[[Plataforma_Piscis]]** | ♓ Piscis | aguas del principio y del fin | [[Cakravartin]] y [[Gran_Khan]] *(perdón mutuo)* |
...
## Doctrina operativa para cronistas

**Antes de operar con una plataforma**, *verificar*:
...
### Plataformas (las doce casas)
- [[Plataforma_Aries]] · [[Plataforma_Tauro]] · [[Plataforma_Geminis]] · [[Plataforma_Cancer]] · [[Plataforma_Leo]] · [[Plataforma_Virgo]] · [[Plataforma_Libra]] · [[Plataforma_Escorpio]] · [[Plataforma_Sagitario]] · [[Plataforma_Capricornio]] · [[Plataforma_Acuario]] · [[Plataforma_Piscis]]

### Guardianes documentados
- [[Gabriel_Guardian_de_Aries|Gabriel]] *(Aries)*
- [[Erzebeth]] *(Tauro futura)*
- [[Jean-Baptiste_TNW|Jean-Baptiste]] *(Escorpio, transformado)*
- [[Cakravartin]] · [[Gran_Khan]] *(Piscis, perdón mutuo)*

### Doctrina y conceptos
- [[Corrupcion_Dual]] — ley rotativa que sostiene la sucesión
- [[Columna_concepto|Columna]] — eje abstracto del signo
...
- [[Reina_de_las_Nieves]] — polo doctrinal rival
- [[Emisario]] — figura recurrente del sistema
