...
aliases:
 ...
 - El Cronomante
 - Pablo Cronomante
 - Pablo del Rito de Reconexión Sagrada
 - El cronomante de Caldero
categoria_diegetica: personaje
epoca: "manifestación en la fase de forja cosmológica de Caldero; salto temporal de emergencia desde la Capilla Oscura; eco residual continuado"
ubicacion_principal: "Capilla Oscura de Caldero como locus de aparición; pliegues temporales múltiples como geografía continuada"
tags:
 - personaje
 - cronomante
 - pablo-linea
...
[*Pablo es la columna cronomántica del cosmos extendido. Donde el tiempo necesita un operador que pueda saltar pliegues sin perder doctrina, Pablo aparece. Que aparezca con nombre distinto en cada manifestación no es disimulo: es respeto al pliegue. —Glosa de [[Arkos]] el archivero del Plata.*]
...
- **Ecos de saltos temporales** *cuya destinación no se preserva*.
- **Visiones de embajadores diabólicos en la penumbra** *(eco del enfrentamiento original)*.

*Las anomalías nocturnas de la Capilla* **son en gran parte ecos residuales del salto temporal de Pablo**, *no operación nueva*. **Pero la operación nueva no se descarta**: **si Pablo regresa a Caldero en alguna fase del próximo ciclo**, *el eco se reactivará como aparición plena*.
