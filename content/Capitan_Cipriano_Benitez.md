...
Hay constancia de que el capitán Benítez mantuvo trato previo con ciertos hombres del grupo conspirador, un trato descrito como realizado «de una manera particular», lo cual sugiere que la relación entre el guardián y los guardados no sigue exactamente la línea que el régimen supondría.

## Vínculos
- [[Torregrises]] — el cosmos troncal bajo cuyo nombre (Santa María de [[Torregrises]]) opera la capital rosista
- [[Clavijero]] — el ex jesuita cuya imprenta Benítez custodia
- [[Santa_Maria_de_Torregrises]] — la ciudad donde ejerce su cargo
