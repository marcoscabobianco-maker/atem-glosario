...
aliases:
 - "Juicio Final (Primer Círculo)"
 - "Juicio Final 1375 DR"

# === Estrato ontológico (Akashic schema v0.1) ===
stratum: ludic
entity_type: event_narrative
entity_type_iri_hint: "golem:NarrativeEvent"

# === Scope ===
campaigns: [atem, mc_core]

# === Cronología diegética ===
diegetic_date: "1375 DR"
diegetic_period: "Primer Círculo"
...
relationships:
 - predicate: defeated
   ...
   notes: "Antagonista — también conocida como Takhishis"
 - predicate: protagonist
   object: Minaya_MC
   object_stratum: ludic
   notes: "27 años en el momento del evento"
 - predicate: protagonist
   object: Soluna
   object_stratum: ludic
 - predicate: uses_artifact
   object: Gema_de_la_Creacion
   object_stratum: ludic
   notes: "Punta de rubí de la Lanza"
 - predicate: preceded_by
   object: Danza_del_Conocimiento
   object_stratum: ludic
   notes: "1368 DR — preludio cosmogónico"
 - predicate: appears_in_source
   object: Calendario
   object_stratum: ludic
   notes: "Pars 199-203"
 - predicate: produces_effect
   object: Retroceso_Temporal_1375_a_1348_DR
   object_stratum: ludic
   notes: "Vuelta del tiempo 27 años — efecto cosmogónico"
...
analytical_notes:
 - by: claude
   date: 2026-05-19
   note: "Cita primaria: Calendario par 200 — 'Minaya (27 años) y Soluna vencen a Takhishis utilizando la Lanza y la Gema de la Creación. Los dioses vuelven atrás en el tiempo hasta el 1348 DR.'"
 - by: claude
   date: 2026-05-19
   note: "Clarisa muere en este evento según MC_LINEA_TEMPORAL — Laveth trama su ascensión divina y mata a Clarisa. Contradicción con 1377 DR sale de prisión (pendiente)."
 - by: claude
   date: 2026-05-19
...
Antes del Juicio Final, Tiamat había sellado a los dioses locales:
...
- [[Calendario]] (fuente)
- [[Minaya_MC|Minaya]] (heroína)
- [[Soluna|Soluna]] (héroe)
- [[Tiamat_MC|Tiamat]] / Takhishis (antagonista)
