...
aliases:
 - Capitán Skellerang
 - Skellerang
 - El financiador de La Jabalina
categoria_diegetica: personaje
epoca: "funcionario imperial activo en el ciclo presente (1824 AE)"
ubicacion_principal: "Caldero; oficina administrativa imperial; contactos con el Templo de San Cutberto y con la guardia urbana"
tags:
 - personaje
 - capitan
 - funcionario-imperial
 - financiador-jabalina
 - licencia-tacita
...
## Las tensiones del cargo

**Skellerang opera con tensiones múltiples**:
...
**Skellerang opera con doctrina del polo luminoso institucional**: **no es héroe, no es paladín, no es figura cosmológica mayor**; **es funcionario que cumple oficio del aparato luminoso con disciplina**. *El cosmos extendido conserva a Skellerang* **como figura ejemplar del operador administrativo que el polo luminoso necesita**: **sin él, los avatares no operarían**; **con él, operan con respaldo invisible que ningún cronista popular registra plenamente**.

[*Skellerang es lo que el polo luminoso del cosmos extendido produce cuando opera en aparato administrativo: funcionario competente que cumple oficio sin solicitar reconocimiento. Pocos lo nombran; el cosmos lo registra. Sin Skellerang, La Jabalina sería banda de proscritos. Con él, son héroes operativos. La diferencia importa. —Glosa de [[Arkos]] el archivero del Plata.*]

---

## Vínculos

- [[La_Jabalina]] — grupo que financia
- [[Caldero]] — ciudad de oficio
- [[Templo_de_San_Cutberto]] — coordinación eclesial
- [[Jenya_Urikas]] — sacerdotisa con quien coordina
- **Guardia urbana de Caldero** — institución con la que gestiona tensión
- **Aparato imperial metropolitano** — superiores administrativos
- [[Bastardo_Cromas]] — sede operativa que su financiación hace posible

## Apariciones

- **Período administrativo previo al ciclo presente** — establecimiento como funcionario imperial en Caldero
