...
aliases:
 - Concilio Tribal NC
 - Concilio de las Tres Naciones
 - la mesa del humo
categoria_diegetica: evento
epoca: "Northern Crown — siglo XVII tardío"
ubicacion_principal: "aldea tribal en bosque del este norteamericano — círculo de wigwams"
tags:
 - evento
 - concilio
 - tribal
...
> *"Se decidió por el humo, no por el aplauso. Quien necesite aplauso, vaya a otra cosa que no sea un concilio."*

**Alrededor del fuego central**: **tres ancianos sentados en círculo cerrado**, vestiduras de cuero franjeado, **plumas en la frente**, **el sahumerio asciende derecho hasta perderse en las copas de los pinos**. *Detrás, dos wigwams construidos de troncos y corteza* —**el de la izquierda muestra el sello de la tribu, el de la derecha está a oscuras**; alrededor, **media docena de mujeres y hombres sentados en el suelo**, escuchando, **manos cruzadas sobre las rodillas**. *Por el lado derecho de la lámina*, **una figura blanca de coat y polainas se aproxima sin invitación**, *visible para todos, mirada todavía sin pedir permiso*. **El concilio sigue sin levantar la voz**.
...
- [[Northern_Crown_NC|Northern Crown]] — el ciclo donde el concilio aparece
- [[Anti_Inferno|la figura del segundo círculo]] — figura que acude o se aproxima
- [[Tres_Naciones_del_Bosque_NC|Tres Naciones del Bosque]] — las tribus convocadas
- [[Flying_Dutchman_Holandes_Errante|Holandés Errante]] — el adversario sobre el que el concilio delibera
- [[Salem]] — agente externo en juego
- [[Akala]]

## Apariciones

- **Fase media de Northern Crown** — concilio de la decisión alrededor del fuego
- **Noche de humo derecho** — decisión final por columna ascendente
