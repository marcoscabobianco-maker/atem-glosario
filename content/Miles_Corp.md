...
aliases:
 - Miles Corp
 - Miles
 - La empresa de las escobas voladoras
 - El Milagro de Miles
categoria_diegetica: facción
epoca: "empresa industrial-mágica activa desde la aceleración de la Revolución Industrial Mágica post-1812 AE"
ubicacion_principal: "Ciudad Estrella; exportación a Caldero y otras geografías del mundo-gema"
tags:
 - faccion
 - empresa
 - industria-magica
...
**Miles Corp opera como **figura cosmológica menor del polo industrial-mágico*** *del cosmos extendido*. **No es entidad mayor** (*no es papado, no es deidad, no es linaje cosmológico*); **pero acumula peso operativo** en cada producto que vende. *Si el [[Papas_Borg|papado oscuro]] gesta nuevo Papa Borg de estética industrial-mágica*, **Miles Corp será** *uno de los vehículos comerciales del aparato*; **sus escobas voladoras** *podrían operar como insumo logístico* **para la operación papal del próximo ciclo**.

*El cosmos extendido lo observa con cuidado*: **una empresa puede ser inocua, o puede ser anticipación de cuerpo cosmológico mayor**. **Miles Corp** *opera en el filo*.

---

## Vínculos

- [[Ciudad_Estrella]] — sede
- [[Caldero]] — mercado periférico
- [[Revolucion_Industrial_Magica]] — fuerza que la sostiene
- [[Milagro_de_Miles]] — producto signature
- [[Tony_Malatesta]] — cliente documentado con escoba
- [[Lord_Valanthru]] / [[Titti_Frame]] — clientes potenciales que solicitan artilugios
- [[Papas_Borg]] — papado oscuro cuya manifestación industrial-mágica podría operar con la empresa

## Apariciones

- **Post-1812 AE — Fundación o aceleración** — coincide con la aceleración de la Revolución
- **1824 AE — ciclo presente** — escobas voladoras en circulación entre élites, crítica popular emergente
