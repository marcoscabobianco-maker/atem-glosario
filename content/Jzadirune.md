...
epoca: "enclave activo en otras eras; estado actual de abandono parcial; accesible vía Fortaleza de Malaquita en el ciclo presente"
ubicacion_principal: "bajo Caldero, conectado con la Fortaleza de Malaquita por puertas de engranajes"
tags:
 - lugar
 - subsuelo
 - enclave-gnomico
...
## El Fabuloso y los créditos mágicos

**Las comunidades gnómicas de Jzadirune operaban "afines al Fabuloso"** —*figura cosmológica mayor del cosmos extendido*— *bajo amparo de **créditos mágicos*** *que el Fabuloso facilitaba o gestionaba*. **Los créditos mágicos** *son operación arcana de financiación* **que permite a comunidades menores sostenerse al abrigo de potencias mayores**. *Su naturaleza específica* **no se documenta plenamente** en el compilado de Mascor Blancarba; **opera como dato cosmológico residual** que requiere investigación de archivero del Plata.

**Las torres de muerte** *—"firma inseparable del ex-Boreal y Regulador"*— **son estructuras cosmológicas que el Fabuloso mantenía** en torno a Jzadirune **como protección y como amenaza simultánea**. *La doctrina del archivo*: **las torres operan con doble función**: **protegen a los gnómicos del exterior**, *pero* **vigilan a los gnómicos mismos**, **garantizando su lealtad al Fabuloso**. **Tras el desvanecimiento del enclave**, *las torres podrían* **conservar operación residual** *que el cosmos extendido no ha terminado de neutralizar*.

---

## El desvanecimiento y la desgracia

*Mascor Blancarba registra con sequedad*: **"esas historias han conocido su desvanecimiento y desgracia (continuar averiguando)"**. **El enclave gnómico cayó en algún momento del ciclo anterior**, *por causas que el archivo no precisa*:

- **Conflicto con criaturas del Subóscuro** *que el enclave no consiguió contener*.
- **Pérdida del amparo del Fabuloso** *cuando la figura cosmológica se desplazó a otros pliegues*.
- **Operación del polo negativo** *que penetró el enclave y lo despobló*.
- **Cosmología mayor** *que retiró las condiciones operativas del enclave*.

*Las causas no se excluyen*. **Pueden operar en sinergia**.

---

## El estatuto cosmológico actual

**Jzadirune en el ciclo presente** *opera como territorio de operaciones pendientes*:
...
- [[Caldero]] — ciudad superior
- [[Fortaleza_de_Malaquita]] — sub-estructura adyacente conectada por puertas de engranajes
- [[Keygan_Ghelve]] — cerrajero superficial cuyas llaves abrieron las puertas
- [[El_Fabuloso]] — figura cosmológica mayor bajo cuyo amparo operaba el enclave
- **Torres de muerte** — estructuras cosmológicas residuales
- **Créditos mágicos** — operación arcana de financiación gnómica
- [[Ayrton_Auslander]] / [[Scylla|Sila]] / [[Tony_Malatesta]] — subgrupo que cruzó las puertas
- [[La_Jabalina]] — grupo cuya operación futura puede penetrar plenamente el enclave
