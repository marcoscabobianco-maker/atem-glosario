...
aliases:
 ...
 - París post-implosión
 - la ciudad de los relojes nocturnos
categoria_diegetica: lugar
epoca: "post-implosión de la Catedral; tiempo no lineal continuo"
ubicacion_principal: "París refundada — sobre el sitio de la antigua catedral implosionada"
tags:
 - lugar
 - ciudad
 - paris-ucronica
...
**Su modelo doctrinal es la [[Sigil|Ciudad de las Puertas]]** —la metrópolis astral de los planos exteriores—; *los portales que se abren en NEO-PARÍS no conectan sólo con otros lugares, sino con otros tiempos*. **Un portal sobre la Rue de Rivoli conduce al siglo XIX en versión sin Revolución; otro sobre el Quai d'Orsay conduce a 2089**, **un tercero a Alejandría del año 415**. El sistema de portales **se enciende y se apaga sin patrón conocido**: el habitante aprende a leer los signos de iluminación nocturna y a no entrar al primero que se le ofrezca.
...
[*Hay ciudades que envejecen y se mueren; hay ciudades que envejecen y se renuevan. NEO-PARÍS es de las segundas, pero con una vuelta de tuerca: se renueva en todos los tiempos a la vez. — Glosa atribuida al [[Pablo_de_Alejandria|Paulus Alexandrinus]].*]

## Vínculos

- [[Catedral_de_Notre-Dame_PU|Catedral]] — la que implosionó y abrió el sitio
- [[Sigil]] — modelo doctrinal de ciudad-de-puertas
- [[Guardianes_de_Antiterra|Guardianes del Tiempo]] — consejo gobernador presumible
- [[Palacio_del_Tiempo]] — administración persistente
- [[Iriarte_Subprefecto|Subprefecto Iriarte]] — burocracia operativa
- [[Apocalipsis_Temporal_1889]] — evento que detonó la implosión
- [[Akala]]
