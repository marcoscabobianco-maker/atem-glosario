...
ubicacion_principal: "Mansión de Paraná y Santa Fe, Buenos Aires"
tags:
 - "faccion"
 - "malvinas"
 - "tulu"
...
El Millón no se queda en trasfondo: es **quien contrata al grupo**. Son estas logias las que encargan a la partida arrastrada a las islas por el [[Operativo_Condor|Operativo Cóndor]] el trabajo sucio del Atlántico Sur —el **rito del faro**, donde la [[Circonio_Piedra_Azul|Piedra Azul]] abre la boca— y las que después reclaman su precio: el **"cambio"** del paquete que viajaba en el avión secuestrado, la mercadería por la que se mueven todos los hilos.

Sus hombres de campo son los que la mesa nombra como **la mala compañía**. El camarada **[[Ricardo_Moretti]]** —que en las islas también se hace deletrear sencillamente Moretti— es el nexo de la intriga con los cóndores de [[Dardo_Cabo]] y la voz que siembra la desconfianza: es él quien señala a la geóloga [[Irene_Kowalski|Irene]] como traidora, "gente del norte", y quien arrastra el nombre del [[Harrington|Dr. Harrington]] al costado oscuro de la trama. Junto a Uriel, Moretti es la presencia de las logias que el estanciero [[Ernesto_Echegoyen|el Pupe]] huele mal y no quiere bajo su techo: la avanzada terrenal de El Millón, metida hasta el cuello en un asunto cuyo fondo ni ellos mismos terminan de medir.
...
Las logias se nombran en la mesa de varios modos que conviene unificar: la mansión de Paraná y Santa Fe aparece como **"El Millón"** y como **"Avilión"** —dos nombres para la misma casa neogótica de diez pisos—, y la hermandad masónica se deletrea **"la Pedue"**, esto es **P2 / Propaganda Due**. Los nombres reales de la política argentina y de la masonería —**Lucio Gelli**, la **P2**, **Vandor**, **López Rega**— se conservan tal cual, como el resto del vestíbulo histórico en el que esta sub-campaña injerta el culto: la trama no los disfraza, los usa como puerta. El **cuaderno 99** es la fuente del tramo isleño. **Uriel** y el camarada **Moretti / Ricardo Moretti** no tienen entrada propia y se nombran aquí en cuanto son la mano de campo de estas logias.
