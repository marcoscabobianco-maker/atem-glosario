...
El **Mundo de Archontos** —*World of Archontos*— es **el setting de campaña sobre el cual transcurre [[Arden_Vul|Ardis Vala]]**. Documentado en `APP_World_of_Archontos.md` (20 páginas) dentro de la carpeta `Arden_Vul_Working/`. El nombre "Archontos" remite a los **archontes** —en griego, los magistrados regentes; en gnosticismo, los principados que gobiernan el cosmos material—. La adaptación MC mantiene el peso doctrinal del nombre: el mundo está gobernado por figuras de orden.
...
Según `APP_World_of_Archontos.md`:
...
- [[Arden_Vul|Ardis Vala]] — campaña que ocurre acá
- [[Vala]] — setting del ciclo trans-fases
...
- Setting del módulo *Ardisvala* (Barton)
- Adoptado por para la campaña Ardis Vala (2024-2026)
- Documentado en `APP_World_of_Archontos.md`
