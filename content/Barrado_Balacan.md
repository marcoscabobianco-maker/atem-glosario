...
### Tres nombres en capas históricas

| Era | Nombre | Estado |
|---|---|---|
| **Imperial arconteano** (hace ~1000 años) | **Ardisvala** | Ciudad imperial activa |
| **Post-caída imperial** | **Balacán** | Tierra fronteriza |
| **Post-hiato + Ravenloft** | **Barrado Balacán** | Dominio gothic-feudal |

**"Barrado"** sugiere **frontera cerrada / cerca / bloqueo** — refuerza la **niebla cerrada del dominio [[Valakhan_de_la_Bruma|Ravenloft]]**.
...
- [[Ardis_Vala]] — nombre histórico imperial
- [[Valakhan_de_la_Bruma]] — dominio Ravenloft que envuelve la región
- [[Mega_Dungeon_Arden_Vul]] — subsuelo
