...
aliases:
 ...
 - Mitos fundacionales del Caldero
 - Apéndices y Delirios Varios
 - Corpus mítico de Caldero
categoria_diegetica: indice
epoca: "mitos primigenios del mundo-gema; compilados por Mascor Blancarba en diciembre 1824 AE"
ubicacion_principal: "Caldero como geografía mítica; corpus conservado en el compilado Gacetilla de Caldero"
tags:
 - indice
 - mitos
 - fundacionales
...
**Los Mitos Fundacionales de Caldero** son **conjunto de mitos primigenios del mundo-gema** *(de [[Vala_Cristalis]])* **cuya operación cosmológica antecede al cómputo conocido**. *Compilados con cuidado por* **[[Mascor_Blancarba|el bardo Mascor Blancarba]]** en la sección **"Apéndices & Delirios Varios"** *de su [[Gacetilla_de_Caldero|Gacetilla de Caldero]]* (diciembre 1824 AE).

*El bardo opera con doctrina explícita*: **registra los mitos sin pretender exhaustividad**, *con la voz del cronista que sabe que los mitos preceden a las crónicas y que un compilado tardío no agota el corpus*. **El cosmos extendido conserva los mitos en transmisión oral popular**; **el compilado los fija parcialmente en archivo legible** para próximos cronistas.

---

## Los mitos compilados

### Mitos de figuras míticas mayores
...
## Las tres lecturas operativas

*El corpus admite tres lecturas* —*el archivo del Plata las distingue sin elegir*—:

1. **Lectura decadiana ortodoxa**: los mitos son **alegorías morales** del orden natural y el polo luminoso primigenio; **operan como pedagogía religiosa**.
2. **Lectura serpentina clandestina**: los mitos son **doctrina cosmológica primigenia** anterior al aparato decadiano; **operan como tradición popular preservada** pese a la represión papal.
3. **Lectura cristalina** *(reciente, asociada a [[Casa_Azul_de_Vala]])*: los mitos describen **el orden primigenio del mundo-gema** [[Vala_Cristalis]]; **operan como cosmología material del cristal mismo**.

*Las tres lecturas no se excluyen plenamente*. **El corpus es robusto en parte porque admite las tres simultáneamente** *sin colapsar en una sola*.
...
*Ninguna fuente sola conserva el corpus completo*. **La operación del archivo cosmológico** *es de triangulación entre todas*.
...
- [[Gacetilla_de_Caldero]] — compilado donde se conservan los mitos
- [[Caldero]] — ciudad sobre cuya geografía operan
- [[Vala_Cristalis]] — mundo-gema de los mitos primigenios
- [[Aguila_Asvila]] · [[Serpiente_Luna_Auna]] · [[Fenix_Nido_Volcanico]] · [[Diosa_del_Mazo_de_Muchas_Cosas]] — figuras míticas mayores
- [[Mito_de_los_Amantes_y_la_Serpiente_Lunar]] — mito específico del pacto
- [[Capilla_de_la_Redencion]] · [[Capilla_Oscura]] — locus de operación mítica
- [[Casa_Azul_de_Vala]] — linaje que conserva fragmentos doctrinales en archivos privados
- [[Pablo_el_Cronomante]] · [[Templarios_del_Tiempo]] — figuras del mito de la Embajada de los Diablos
