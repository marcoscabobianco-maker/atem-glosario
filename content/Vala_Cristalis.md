...
> *La capa de cristal que protege lo que no debe entrar. Nace del Valis Cristal de Paladin in Hell, sostiene el mundo-gema Vala Cristalis, vuelve a estar en disputa en el Sancta Sanctorum del Inferno.*

## Presentación

Vala Cristalis es **una capa de cristalización cosmológica** —no un objeto, no una superficie material en el sentido bajo, sino el **velo cristalino que protege un mundo de lo que no debería entrar**—. Su forma cambia según donde se encarne: en el mundo-gema [[Eilidh]] / [[Vala_Cristalis|Vala Cristalis]] es **la cobertura externa** del rubí donde 1.200.000 almas se refugiaron antes de la colisión Terra-Antiterra; en Buckingham es **la defensa cristalina** que rodea el palacio de Lucifer; en el **Sancta Sanctorum** del primer nivel del Inferno es **el objeto en disputa** —lo que muchos quieren obtener y por lo que se desata la lucha de todos contra todos—.

El **Fénix** actúa como termostato viviente de la capa: cuando se daña, **genera la Fuga Entrópica** y la resurrección deja de funcionar. Vestigios de capas antiguas conservan susurros de épocas en que el [[Rio_Oukronos|río Oukronos]] corría por otros cauces.

### Origen: el Valis Cristal de Paladin in Hell

El concepto nació en **[[Paladin_in_Hell|Paladin in Hell]]** —la aventura clásica de Monte Cook para 2da edición— como **Valis Cristal**. Aquel arco fue uno de los **fundacionales de la el cosmos compartido**: ahí surgen **Maristo y Arian juntos**, con sus pactos con [[Grazzt|Graz'zt]] y con el destino del maestro de Maristo —**[[Klyssandral]]**, *"se habían arrastrado todo un templo al quinto nivel del imperio"*—. De ese arco extrajo y reelaboró el **Valis Cristal en Vala Cristalis**, dándole el peso adicional de la referencia blakeana —*Vala, or The Four Zoas*— y proyectándolo como concepto cosmológico recurrente en todas las campañas posteriores.
...
- [[Paladin_in_Hell|Paladin in Hell]] — el arco donde nació como Valis Cristal
- [[Klyssandral]] — maestro de Maristo, templo arrastrado al quinto nivel
- [[Maristo]] / [[Arian]] — los que emergieron juntos del arco fundacional
- [[Grazzt|Graz'zt]] — uno de los actores del pacto en el arco
- [[Eilidh]] / [[Vala_Cristalis|Vala Cristalis]] — el mundo-gema que protege como capa externa
- [[Franja_de_la_Disolucion_TG|Franja de Disolución]] — el límite que motivó el arca-rubí
...
- Paladin in Hell — arco fundacional, Valis Cristal original
- Caldero / La Jabalina — capa protectora externa del mundo-gema Vala Cristalis
- el Descenso (Inferno) — disputa en el Sancta Sanctorum
- Crossovers Masters × Mundo de Krile (con Cristo León)
