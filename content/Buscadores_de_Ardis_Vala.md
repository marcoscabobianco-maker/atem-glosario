...
epoca: "ciclo primero del valle; regreso tras el Hiato de los Quince Años en el ciclo presente"
ubicacion_principal: "Mega-Dungeon de Ardisvala; valle de Valakhan de la Bruma; Palacio del Prisma"
tags:
 - faccion
 - grupo
 - ardisvala
...
- **El Druida Rodrigo** — humano, llegado tarde al grupo, primer druida convertido en vampiro y muerto en el Templo de Thoth durante el Hiato.
...
- [[Palacio_del_Prisma]] — sede del Papa
- [[Master_Malakita|Master Malakita]] — antagonista mayor del primer ciclo
- [[Caballeros_Cicatriz_del_Sol|Cicatriz del Sol]] — orden tomada por el grupo en la fase media del ciclo primero
- [[Valdemora]] / [[Estellara]] / [[Ciudadela_Sin_Sol]] — geografía del regreso
- [[Bellaca|Bellaca / Lali]] — reencuentro pendiente
- [[Arkos|Archivero del Plata]] — anexado al grupo por orden del Papa
- [[Decadiano]] — doctrina cuyo aparato los procesa
...
- **Hiato de los Quince Años** — el grupo no opera; el valle cambia bajo bruma y fiebre blanca
- **El regreso** — anexión de Decio, descenso por la Ciudadela Sin Sol, caída al Palacio del Prisma, "en la lista" del Papa
- **Ciclo presente** — operativos en Valakhan bajo el ojo del Papa Alejandro VI
