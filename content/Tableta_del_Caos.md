...
aliases:
 - Tableta del Caos
 - Las Tabletas del Caos
 - La Tableta
 - El objeto-misión del Abad
categoria_diegetica: objeto
epoca: "encargada por el Abad de Helix al grupo de Helix; no recuperada al cierre del ciclo presente"
ubicacion_principal: "ubicación desconocida; el brujo del umbral murió antes de saberla"
tags:
 - objeto
 - mision-abad
 - tableta
...
Al cierre del ciclo presente, **la Tableta del Caos sigue desconocida y no recuperada**. **El plazo del Abad sigue corriendo** —*cuando regrese de la capital regional, su exigencia se reactivará sin haber sido cumplida*—. *El cronista del Plata anota como pendientes mayores*:
...
3. **¿Está conectada al mundo-gema [[Vala_Cristalis]]** —*cosmología del [[La_Jabalina|Caldero]] previo*—, *o es objeto propio de la geografía del valle*? El nombre **"Caos"** sugiere lectura cosmológica antigua, *no necesariamente local*.
...
- [[Helix]] — aldea desde donde se encargó la misión
- [[Vicario_Otar]] — autoridad eclesial que interrumpió el deseo del brujo
- [[Silas_del_Umbral]] — brujo que pidió la información y murió antes de recibirla
- [[Quasi_demonio_menor]] — demonio que ofreció el conocimiento en pacto
- [[Mortan]] — clérigo bisagra de la sincronía liturgia
- [[Iglesia_Consagrada_Helix]] — recinto donde se pronunció el deseo interrumpido
- [[Barrowmaze]] — presunta ubicación de la Tableta
- [[Buscadores_de_Ardis_Vala]] — grupo del norte que podría encontrarse con la búsqueda al descender al sur
- [[Vala_Cristalis]] — posible eco cosmológico (hipótesis abierta)
