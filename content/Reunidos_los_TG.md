...
- **Una mujer o andrógino que miraba al frente**
- **Un grande de cabellos hindúes con gesto suave**
- **Uno de luenga barba, pesado, lento**
- *(El cuarto no está descrito con detalle en las menciones que el archivo conserva)*

**Fórmula de saludo** atestada: *"Salve, que los modos nos sean propicios."*
...
- **Cosmogonía Gris** — 4 menciones (creación, planos, arca con adoradores)

## Nota lateral

> *La doctrina general de "los Reunidos" en sentido amplio aparece también en [[Linea_Arian_Avatares|la doctrina de los avatares de Arian]] — uso secundario del término para nombrar la operación cosmológica persona+sombra. Los dos sentidos son distintos: los Reunidos del galeón marrón son cuatro figuras concretas; la doctrina general es marco interpretativo.*

## Ver también

- [[Torregrises]]
- [[Soluna]] — caracterización corregida
- [[Linea_Arian_Avatares]] — uso secundario doctrinal del término
- [[Minaya_MC]] — adoradores tardíos
