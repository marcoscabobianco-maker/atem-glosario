...
**El Arcanum es a la vez**:
- **Sustancia material** —líquida, sólida cristalizada, o gaseosa según contexto
- **Energía mágica** —fuente de hechizos arcanos y divinos
- **Memoria cósmica** —tiene **conciencia** posible (vinculada a las IAs rudishva)
- **Vector planar** —conecta dimensiones, sustenta los teleporters rudishva

### Quien la persigue

| Facción / figura | Interés |
|---|---|
| **[[Kerbog_Khan]]** | Obsesión personal —sus autómatas se construyen con Arcanum |
| **[[Priscians]] / [[Nerub_Null]]** | Restaurar la [[Arcanum_Forge|Forja Arcanum]] sortiana |
...
> *"Tal vez el arcanum, la sustancia mágica primordial, está durmiendo."*

**Implicación post-hiato**:

- El Arcanum como **flujo activo** del dungeon **puede estar en estado latente** tras la entrada en [[Valakhan_de_la_Bruma|Ravenloft]] + [[Cristalizacion_Maquinas|cristalización de las máquinas]]
- **Despertar pendiente** —si los compañeros logran reactivarlo, el dominio puede transformarse
- **Conexión con [[Ardipithecus|Graz'zt-Ardipithecus]]**: el ardipitecus se "guardó aquí" con el Arcanum durmiente como custodio cósmico
...
- [[Ardipithecus|Graz'zt-Ardipithecus]] — proto-guardián cosmológico
- [[Valakhan_de_la_Bruma]] — dominio actual
