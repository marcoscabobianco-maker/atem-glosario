...
epoca: "reforma decadiana hacia 1700 AEP; vigente con tensiones doctrinales internas en el ciclo presente"
ubicacion_principal: "Gran Basílica de Archontos; templos provinciales en el Valle de Burdock y todo el Imperio; santuarios clandestinos de los Doce en zonas rurales"
aliases:
 - Iglesia Imperial
 - Iglesia Ortodoxa Imperial
 - Ortodoxia Decadiana
 - Iglesia Decadiana
 - La Iglesia
 - Los Diez
...
La **Iglesia Imperial** —*la Iglesia*, sin más, en boca de los archonteos comunes; **Iglesia Ortodoxa Imperial** o **Iglesia Decadiana** en los pliegos oficiales— es **la religión oficial del Imperio Archonteo**. **Su unidad es de aparato, no de doctrina**.

Tras la **Guerra de los [[Sortianos]] y [[Teosofos|Teósofos]]** —*conflicto que aunque se origina en cuestión mágica derivó en fractura religiosa generalizada hacia el 1775 AEP*—, el culto oficial fue **reformado drásticamente**. Los antiguos **Doce dioses patronos de Archontos** —*pánteon heredado del primer Imperio*— fueron **reemplazados, reinterpretados o absorbidos** por una nueva **Ortodoxia de los Diez Dioses**. Este es el nombre completo de la doctrina dominante: ***Ortodoxia Decadiana***, *del decadianus archonteo*, "del Diez".

La reforma no eliminó el panteón anterior. **Lo cerró oficialmente, lo reordenó parcialmente y lo dejó respirando por debajo**.

---

## Los Diez del nuevo orden

La **Iglesia Ortodoxa Imperial / Decadiana** venera al **panteón de los Diez Nuevos Dioses**. La lista completa, *con función doctrinal y relación —cuando se conoce— con los Doce antiguos*, se conserva en los pliegos imperiales:

| Dios | Función doctrinal | Relación con los Doce |
|---|---|---|
| **[[Asterion]]** | Sol diurno, justicia imperial | Posible aspecto sintético de [[Mitra]] |
| **[[Nemea]]** | Sabiduría, archivo, ley | Aspecto femenino de **[[Thoth]]** según teósofos; reformulación según Ortodoxia |
| **[[Zahon]]** | Muerte redentora, tránsito | Reemplazó al antiguo **[[Horus_dios_archonteo|Horus]]** del pueblo Wiskin |
| **[[Sutekh]]** | Secretos, sombra calibrada | Posible **[[Set]] disfrazado** según los teósofos clandestinos |
| **[[Mitra]]** | Sol cabalgador, juramento | **Único de los Doce explícitamente incorporado** al nuevo panteón |
| *(cinco más)* | *(en preservación parcial del archivo decadiano)* | *(varios pendientes de identificación)* |

*El cronista anota que la lista completa no aparece en pliegos de provincia — sólo en la Gran Basílica de Archontos, donde el Primarca conserva el manuscrito doctrinal entero*. Los cinco restantes son **conocidos por el clero ortodoxo de mayor jerarquía** y *recitados en oraciones litúrgicas* pero **no documentados públicamente** en los archivos provinciales del valle.

**Sede**: la **Gran Basílica de Archontos**, capital imperial. El **Primarca** es designado por el **[[Drusus_IX_El_Palido|Basileus]]** vigente.
...
## Los Doce antiguos: la Vieja Fe que respira por debajo

La **Vieja Fe Imperial** —*cultos teósofos*— venera **a los Doce Dioses Antiguos**, originales de Archontos. La lista, en parte conocida y en parte fragmentaria:

| Dios | Función original | Estado bajo la Ortodoxia |
|---|---|---|
| **[[Thoth]]** | Conocimiento, escritura, magia | Antiguo, *tolerado parcialmente* (su Orden mágica permanece bajo nombre nuevo) |
| **[[Set]]** | Noche, secretos oscuros, frontera | **Prohibido oficialmente** —*involucrado en el bando teósofo derrotado*— |
| **[[Horus_dios_archonteo|Horus]]** | Cielo diurno, nobleza guerrera | **Prohibido oficialmente** —*asociado al imperio anterior pre-Cisma*— |
| **[[Bastet]]** | Felinos, fertilidad, hogar | *Tolerada* en zonas rurales |
| **[[Anubis]]** | Guardián de tumbas, tránsito funerario | *Tolerado* |
| **[[Mitra]]** | Sol cabalgador | **Único incorporado** al nuevo panteón |
| *(seis más)* | *(parciales)* | *Varios prohibidos, varios tolerados en privado* |
...
## La reforma drususiana y las tensiones modernas

Tras la guerra civil, el emperador **[[Drusus_V|Drusus V]]** impuso paz teológica con concesiones operativas:

- **Abrió la Orden de Thoth a cualquiera con talento mágico** —*concesión doctrinalmente sortiana, formalmente ortodoxa*—.
- **Retiró la persecución activa de los teósofos** —*siempre que no se organizaran como cuerpo institucional*—.

Esa paz se ha sostenido, *con tensiones*, hasta el reinado del **[[Drusus_IX_El_Palido|Basileus Drusus IX]]**. Las tensiones del ciclo presente son tres:
...
*Las dos posibilidades operan en los pasillos de la Gran Basílica.*

---

## El debate cosmológico abierto

La pregunta doctrinal que **el archivo no resuelve**: **¿Son los Diez y los Doce realmente distintos, o aspectos de las mismas deidades bajo nuevos nombres?**
...
- [[Drusus_V]] — emperador que impuso la paz teológica abriendo la Orden de Thoth
- [[Sortianos]] — facción aliada doctrinal de la Ortodoxia en el Cisma
- [[Teosofos]] — linaje de la Vieja Fe, opositor doctrinal histórico
- [[Priscus_Pulcher]] — líder mártir sortiano honrado en privado por algunos obispos
