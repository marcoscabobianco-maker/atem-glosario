...
aliases:
 ...
 - Abelicio
 - El Guerrero Gostoso
 - El de la frase "¡Belleza!"
 - El guerrero negociador del doble sueldo
categoria_diegetica: personaje
epoca: "miembro fundador de La Jabalina; activo en el ciclo presente (1824 AE)"
ubicacion_principal: "Caldero; taberna Bastardo Cromas; sótano del Bastardo Cromas para rutinas de combate"
tags:
 - personaje
 - jabalina
 - guerrero
 ...
 - gostoso
 - belleza
 - taberna-bastardo-cromas
 - doble-sueldo
 - lovecraftiano-mutacion-posible
imagen: Imagenes_Tier1/Belicio.png
---
<!-- HEADER_IMG -->
![[Imagenes_Tier1/Belicio.png]]
<!-- /HEADER_IMG -->
...
## El sótano del Bastardo Cromas

**Belicio practica sus rutinas de combate a media noche en el sótano del Bastardo Cromas, sin camisa, por supuesto**. *Gossip & Style* especuló: **"¿Se entrenan o están montando un club de pelea secreta?"**. *Vecinos anónimos* reportaron *"un resplandor en el subsuelo y golpes"*.

**La realidad operativa**: *Belicio mantiene disciplina física rigurosa pese a la apariencia despreocupada*. **El sótano del Bastardo Cromas** —*amplio, vacío de muebles, con suelo resistente*— **sirve como sala de entrenamiento privada**. **Belicio entrena en horarios atípicos** *para que el resto del grupo descanse*; **el "sin camisa" no es performance**, *es necesidad práctica del entrenamiento intenso*. *Los rumores de "secta" o "fiestas clandestinas"* **son malentendidos de vecinos que no conocen el oficio guerrero**.

---

## La nota del mago lovecraftiano: una mutación posible

**El archivo conserva fragmento antiguo** —*pre-compilado de Mascor Blancarba, en archivos de cronistas anteriores*— que **mencionaba a Belicio como posible figura mutada por contacto con manchas de Rorschach**, *"criatura lovecraftiana surgida en fase 4 de operaciones"*. *La grafía variante* **"Abelicio"** *parecía relacionarse con esta mutación*.

**En el compilado actual (1824 AE)**, *Mascor Blancarba no registra la mutación*. *Belicio opera como guerrero humano sin rasgos lovecraftianos visibles*. **Tres lecturas posibles**:

- **La mutación es anticipada para el próximo ciclo** *que el ciclo presente todavía no ha desencadenado*.
- **La mutación es alternativa cosmológica** *en pliegue paralelo del cosmos extendido que el ciclo presente no opera*.
- **El fragmento antiguo es error de archivo** *o mezcla con otra figura cosmológica distinta*.

*El archivo conserva las tres lecturas sin pronunciarse*. **Por defecto**, *el Belicio del ciclo presente es guerrero humano gostoso*; **la mutación lovecraftiana queda como anticipación abierta** *si el cosmos extendido la requiere*.
...
- [[Bastardo_Cromas]] — sede operativa, taberna de operaciones sociales, sótano de entrenamiento
- [[Templo_de_San_Cutberto]] — uno de los dos contratantes del doble sueldo
- **Guardia de Caldero** — el otro contratante
- [[Bazar_de_la_Vida]] — primera misión, hobgoblins cortados
- [[Senda_de_Drakthar]] — segunda misión
- [[Temporada_de_Inundaciones]] — tercera misión
- [[Kazmojen]] — adversario combatido en el Bazar
- [[Howler]] — adversario combatido en la Fortaleza
- [[Foggimer]] / [[Lukas]] / [[Teo_Paladin_Sin_Brazo]] — compañeros de la cargas principales
