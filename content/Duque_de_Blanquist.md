...
aliases:
 - Duque de Blanquist
 - Duca di Blanquist
 - el invitador invisible
 - sello de los seis dedos
categoria_diegetica: personaje
epoca: "Belle Époque uchrónica — 13 maggio 1914 / antes y después"
ubicacion_principal: "salones de París / palco invisible del Palacio del Prisma"
tags:
 - personaje
 - paris-ucronica
 - palacio-del-prisma
...
> *"Ogni grande evento ha bisogno di un testimone. Ogni svolta della Storia ha bisogno di un invitato."*

**Al Duque por lo que no muestra**: la silueta translúcida de una bata oriental, la mano extendida sobre el escritorio, **el rostro literalmente ausente**. *El cronista anota que cuando un retratista no consigue cara, la culpa no es del retratista*. **Sobre el escritorio, el sobre con sello de lacre rojo**: la huella del sello, cuando se la mira de cerca, **es huella de mano humana con seis dedos**. La nota inferior precisa: *Il mittente di questo invito non può essere visto. Ma la sua mano lascia sempre lo stesso sigillo.*
...
- [[Palacio_del_Prisma]] — el Castillo desde el que la invitación se emite
- [[Helter]] — hijo de Elías, nuevo demonio de seis dedos en el linaje
- [[Lotario]] — entrada del Glosario donde el sexto dedo aparece confirmado
- [[Sello_de_los_Seis_Dedos]] — la marca compartida
- [[Tel_demonio_Catedral]] — el primer "maldito demonio de seis dedos" del archivo
- [[Akala]]

## Apariciones

- **13 maggio 1914 — París** — la invitación al grupo, sello de seis dedos, salón privado en Rue de Grenelle
- **Belle Époque uchrónica — apariciones laterales** — su mano aparece en otros sellos, sin que el cuerpo se asome
