...
aliases:
 - Ciudad Estrella
 - Capital del Mundo-Gema
 - Torreluces (nombre alternativo de la ciudad-hermana)
 - La ciudad de las torres altas
 - La urbe post-papado
categoria_diegetica: lugar
epoca: "fundada en el primigenio; teocracia papal hasta 1812 AE; revolución industrial-mágica vigente desde entonces"
ubicacion_principal: "norte del mundo-gema Vala Cristalis; ~100 km al norte de Caldero; manifestación geográfica sobre otra de las Plataformas primigenias"
tags:
 - lugar
 - ciudad
 - ciudad-estrella
 - capital
 - revolucion-industrial-magica
 - torreluces
 - papa-borg
 - plaza-de-obsidiana
 - vala-cristalis
...
## Las innovaciones de Ciudad Estrella
...
- **Marcas de armaduras Pristine y Goze** — *armaduras con encantamientos integrados desde la forja*.

- **Cascos de teleportación** — *desplazamiento de corto alcance, aún costoso pero disponible*.

- **Universidades de conjuros** — *centros de enseñanza mágica que combinan tradición teurga con investigación industrial*.

- **Gremios de artefactos** — *forjadores especializados que pueden producir objetos arcanos en pequeña escala industrial*.

---

## Las facciones de Ciudad Estrella
...
*Linaje añejo, sangre vieja*, **mantienen mansiones en los anillos superiores** pero *han cedido influencia política a los industriales*. **Algunas conservan vínculos con la [[Casa_Azul_de_Vala|Casa Azul de Vala]]** *vía matrimonios remotos*. **Otras**, *como la familia [[Titti_Frame]]*, **operan en ambos mundos** (linaje + industria).

### El culto post-papado

**Fundado por los peregrinos** que liberaron a la Giganta, **culto basado en la justicia y la verdad**. *Conserva las reliquias del mártir profeta* —*nombre no preservado con detalle en los archivos provinciales*—. **Opera con moderación**, *no ha intentado constituirse en nueva teocracia*, **respeta la separación entre aparato eclesial y aparato civil que la caída del Papa Borg estableció**.

### Las sospechas inquietantes

**Algunos vecinos insinúan** —*según Mascor Blancarba*— que **las torres gemelas de cierto linaje influyente albergan experimentos mágicos** *que podrían desencadenar cambios drásticos en la vida cotidiana de la ciudad*. **Existe un creciente murmullo sobre la introducción de tecnología industrial vinculada a la magia**, *pero nadie parece dispuesto a hablar abiertamente del asunto*. **Los más osados apuntan** *a que detrás de esos muros y laboratorios sellados se traman planes para consolidar el poder de unos pocos, potenciando aún más las diferencias sociales*.

---

## La conexión con Caldero

**Ciudad Estrella y Caldero son ciudades-hermanas del mundo-gema**, *unidas por mitos compartidos del Águila/Serpiente-Luna/Fénix*. *Sus destinos divergen tras la caída del Papa Borg*:

- **Ciudad Estrella** *acelera la modernización industrial-mágica*, *enriquece a los nobles industriales*, **abre horizontes** *pero también amplifica desigualdades sociales*.
- **Caldero** *recibe la modernización con cautela*, *conserva sus mitos volcánicos*, **opera bajo amenazas más oscuras** (*conspiraciones, redes de trata, grupo siniestro con marcas*) — *amenazas que en Ciudad Estrella son menos visibles pero pueden estar gestándose en los laboratorios sellados de las torres gemelas*.

[*El cronista Mascor Blancarba salió de Ciudad Estrella para visitar Caldero precisamente porque "los avances en la llamada revolución mágico-industrial" lo impactaron, pero quería contrastar con ciudades hermanas. Su Crónica del Visitante Curioso es uno de los pocos documentos que cruza las dos ciudades en una sola voz. —Glosa de [[Arkos]] el archivero del Plata.*]

---

## La pregunta del próximo Papa Borg

**¿Habrá otro Papa Borg en Ciudad Estrella?** *El archivo registra la posibilidad como abierta*:

- *La memoria del Papa Borg derrotado* **se conserva en la plaza** —*cicatrices visibles, cráter pequeño donde implosionó la Giganta*—.
- **El culto post-papado** *opera como vacuna doctrinal contra la teocracia oscura*.
...
- [[Caldero]] — ciudad-hermana al sur
- [[Gran_Plaza_de_Obsidiana]] — locus de la caída del Papa Borg
- [[Papa_Borg_de_Caldero]] — manifestación derrotada
- [[Papas_Borg]] — tradición dinástica papal oscura
- [[Giganta_Antigua]] — contención cosmológica
- [[Espada_de_Juicio]] — arma de la Giganta
- [[Revolucion_Industrial_Magica]] — fuerza modernizadora
