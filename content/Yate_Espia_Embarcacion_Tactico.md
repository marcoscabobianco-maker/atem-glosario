...
Propósito narrativo: puente logístico entre fuga terrestre ([[Orient_Express|Orient Express]] + Suiza) y llegada a [[Bucarest_Ucronica|Bucarest]] para Sesiones 5-6. Permite [[Time_Bandits|Time Bandits]] reorganizarse, recibir apoyos del Ministerio (papeles falsos, compensación de 1000 francos por cabeza, inteligencia sobre Círculo de Serbia), y mantener discreción diplomática.

Incidente marinero: Ataque de **[[Naga_acuatica|Naga acuática]]** (entidad serpentina de tamaño mayor, capacidades hipnóticas/encantamiento). Batalla en cubierta: Corvino es encantado momentáneamente, [[Swan]] y Claude combaten cuerpo a cuerpo, Philip y Aby atacan con municiones mágicas. Disparo crítico mata a la naga. Cuerpo/cabeza preservada como trofeo macabro (sumergida en salmuera para conservación post mortem).
...
Marinería: identidades mayormente no especificadas; posibles espías del Ministerio o marineros mercenarios reclutados por [[Meteora]]. Algunos con entrenamiento en magia/combate (dado que participan en defensa contra naga).

Tras esta sesión: yate permanece en aguas cercanas a [[Bucarest_Ucronica|Bucarest]], bajo comando de **[[Meteora]]**, como vía de escape contingente ("extracción" si misión en [[Bucarest_Ucronica|Bucarest]] se complica).

## Apariciones notables

[[Paris_Ucronica|París Ucrónica]]: puerto de [[Niza_Costa_Azul|Niza]] (reunión con [[Meteora]], ascenso a bordo), navegación [[Mediterraneo_Ucronico|Mediterráneo]], ataque de naga en alta mar, combate y victoria. Sesión posterior: ancla en aguas cercanas a [[Bucarest_Ucronica|Bucarest]], punto de extracción/escape. Sesiones siguientes: mencionado como opción de fuga (después desaparece de narrativa cuando grupo se enfoca en tierra/[[Isla_de_la_Serpiente|Isla de la Serpiente]]).
