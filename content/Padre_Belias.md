...
aliases:
 - Padre Belias
 - Belias
 - El sacerdote de Ritornello
 - El ferviente
categoria_diegetica: personaje
epoca: "oficio en Ritornello desde aproximadamente 2980 AEP hasta la caída del pueblo"
ubicacion_principal: "Templo de la Divina Década de Ritornello; tras la caída, sobreviviente disperso, paradero en discusión"
tags:
 - personaje
 - sacerdote
 - clero-decadiano
 ...
 - ardis-vala
 - ritornello
 - templo-divina-decada
 - argus-confesor
 - ferviente-en-la-fe-nueva
imagen: Imagenes_Tier1/Padre_Belias.png
---
<!-- HEADER_IMG -->
![[Imagenes_Tier1/Padre_Belias.png]]
<!-- /HEADER_IMG -->
...
El **Padre Belias** —*nombre cuya etimología precisa el archivo decadiano no anota, aunque algunos copistas la asocian con la forma archontea antigua de* **[[Belial]]***, deidad menor del panteón pre-[[Decadiano]]* *que la Ortodoxia neutralizó en la reforma*— **oficia el [[Templo_de_la_Divina_Decada|Templo de la Divina Década]]** de **[[Ritornello]]** desde aproximadamente el 2980 AEP. Llegó al valle como **sacerdote joven enviado por la diócesis de [[Narsileon]]** para *consolidar la presencia ortodoxa en el pueblo recién consolidado bajo el [[Argus_PJ|Barón Argus]]*.
...
*"Ferviente en la fe nueva"*. La fórmula es del aparato eclesial; *no es elogio convencional ni sospecha velada*. **Significa exactamente lo que dice**: el sacerdote profesa la [[Iglesia_Imperial|Ortodoxia Decadiana]] **con devoción declarada**, *sin las medias tintas que algunos clérigos rurales muestran al permitir que la Vieja Fe de los Doce respire en sus pueblos*. **Belias no permite a sus feligreses oraciones privadas a [[Horus_dios_archonteo|Horus]] al amanecer, ni a [[Bastet]] en las cunas**. *Toda devoción* debe pasar por **los Diez**.
...
El **[[Argus_PJ|Barón Argus]]asistía al Templo de la Divina Década como devoto público**. *La devoción del barón era pública, no íntima*: el archivo decadiano lo subraya con cuidado. **Belias lo recibía cada decadía** —*festividad de los Diez celebrada cada décimo día del calendario imperial*— **en el oficio mayor**; *el barón ocupaba el banco principal con su guardia personal*, *recibía la bendición decadiana al principio y al final de la liturgia*, *contribuía al sostenimiento del templo con donativo regular*.
...
**Cuando [[Ritornello]] cayó** —*por libélula con huevo bomba de [[Kerbog_Khan]], en el primer año del [[Hiato_15_Años_Ardis_Vala|Hiato]]*—, **el Templo de la Divina Década se derrumbó** *junto con el resto del pueblo*. *La cúpula menor de bronce* —*orgullo arquitectónico del templo, fundida desde Narsileon en oficio especial*— **fue una de las primeras estructuras carbonizadas**.
...
- **Otra versión** sostiene que **escapó hacia el norte del valle** —*hacia las cabañas thorcin de las laderas, donde algunos feligreses lo escondieron*— y **sobrevivió la caída**, *operando los primeros años del Hiato* como **sacerdote clandestino** en las **cabañas dispersas** del **[[Valakhan_de_la_Bruma|valle ya cosido al dominio brumoso]]**.
- **Una tercera versión** —*minoritaria*— **lo sitúa en [[Estellara]] o [[Valdemora]]** durante el Hiato, **operando con autoridad eclesial directa del [[Papa_Alejandro_Sixto|Papa Alejandro Sixto]]** *cuando el Papa consolidó su sede en el [[Palacio_del_Prisma|Palacio del Prisma]]*.
...
- [[Argus_PJ|Barón Argus]] — devoto público; confesor del barón en momento crítico
