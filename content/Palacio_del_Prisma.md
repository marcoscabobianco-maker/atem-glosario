...
aliases:
 ...
 - Prism Keep
 - Prism Castle
 - La Fortaleza de los Tres Colores
categoria_diegetica: lugar
epoca: "trans-campaña; presencia documentada desde el ciclo primero; consolidación como sede papal tras el Hiato"
ubicacion_principal: "fortaleza volante; en el ciclo presente, anclada sobre el valle de Ardisvala bajo dominio brumoso"
tags:
 - fortaleza-volante
 - prismatico
 - tres-colores
...
Los tres colores no son arbitrarios. **El cronista, que ha cruzado más estandartes de los que conviene confesar**, observa lo siguiente: **verde, amarillo, rojo** son **los colores que la bandera de [[Axum_MC|Abisinia]] lleva hoy sin saber por qué**. Los soldados del estandarte juran sobre ellos como sobre los colores de la república. La república los heredó. *No los inventó.*

El sello del estandarte —*el [[Ardipithecus|pentáculo abisinio]] ya glosado en otra entrada*— **es el centro alrededor del que los tres colores giran**. Verde por el suelo donde el fósil ancestral dormía. Amarillo por el oro pulido de los Custodes. Rojo por la era de la sangre que el Papa preside.

[*La identidad colores-del-prisma ↔ bandera-abisinia ↔ sello-del-proto-guardián es tesis del cronista. Los [[Custodes_Oculis_Solis|Custodes]] la confirman sin discutirla, que es como confirman los celestiales: callando. Los doctrinarios republicanos modernos la rechazarían si la oyeran. **No la oyen.** —Glosa del [[Arkos|archivero del Plata]], cuaderno cinco.*]

---

## La trampa

Los **[[Buscadores_de_Ardis_Vala|Buscadores]]**, en el regreso tras el [[Hiato_15_Años_Ardis_Vala|Hiato]], **cayeron al pentagrama por trampa pisada en la [[Ciudadela_Sin_Sol]]**. La caída no fue accidente. **El Palacio había cosechado sus colores durante el silencio.** Esperaba.
...
**El bibliotecario** —hechicero amigable, humano curtido, **manchas oscuras en la mano que escribe**, anota nombres en libro abierto—. Sirve al [[Papa_Alejandro_Sixto|Papa Alejandro VI]]. Su voz es serena, su tinta lenta. *El cronista, que reconoce a los suyos, observa con interés.*

**Los [[Custodes_Oculis_Solis|Custodes Oculis Solis]]** —*humanoides de luz dorada solidificada, rostro de oro pulido sin facciones, pectoral de águila imperial sosteniendo un ojo de sol*—. Custodios. Sin emoción. **Surgen a los costados del visitante cuando el visitante deja de comportarse**. Sopesan la moralidad en silencio. *Quien intenta forzar el círculo es destruido por ellos sin ceremonia.*
...
**[[Argus_PJ|Argus]]** —paradigma caído, montaraz cazador, *cuerpo del que [[Ardipithecus|Ardipithecus]] se sirve al emerger desde la espada compañera*—. **Se entromete en la lógica del recinto.** El prisma no acaba de absorberlo: lo que él es excede la capacidad cosechadora del castillo.

---

## El trono de rubí

Sobre todo lo demás, **el trono de rubí**. **[[Papa_Alejandro_Sixto|Papa Alejandro VI]]** lo ocupa. *Su porte sereno es el de quien ha pactado con potencias que no se citan en concilio público.* La estética del trono evoca, sin esfuerzo, **los dominios brumosos** y la fachada eclesial del **[[Strahd|señor anterior]]** que algunos archivos no terminan de identificar como par o como espejo.
...
- **Algunos sostienen que es una versión futura de [[Alumine|Alumine Manwe Finwe]]** —la Rockseer Elf del grupo, en una línea que el ciclo presente todavía no ha consumado—.
...
El Palacio conserva, en una de sus salas mayores, **una rama menor de la [[Library_of_Thoth|Biblioteca de Thoth]]**. **Bibliotecarios despertados especialmente para custodiarla** la operan. *Quien tenga oído sufí reconocerá en la disposición de los anaqueles la huella de [[Arcoms_Cosmar|Mithranor / Al-Mital]]*: el plano imaginal asoma en arquitecturas que él mismo no acaba de explicar.
...
## Aparición en el Descenso — el Castillo del Apocalipsis del segundo círculo
...
- [[Hiato_15_Años_Ardis_Vala|Hiato]] — período en el que el Palacio cosechó sus colores
- [[Library_of_Thoth|Biblioteca de Thoth]] — rama menor conservada dentro
- [[Arcoms_Cosmar|Mithranor / Al-Mital]] — huella sufí en la arquitectura interior
- [[Axum_MC|Abisinia]] — origen de los tres colores prismáticos
- [[Ardipithecus]] — sello pentacular abisinio que articula los tres colores
- [[Strahd|Señor anterior de los dominios brumosos]] — eco doctrinal del trono de rubí
- [[Arden_Vul|Ardisvala]] — valle anclado bajo el dominio
