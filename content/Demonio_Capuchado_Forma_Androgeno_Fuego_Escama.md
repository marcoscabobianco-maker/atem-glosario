...
- **Identidad:** Manifestación demoníaca de [[Hugo_de_Payns|Hugo de Payns]] O entidad separada vinculada
- **Descripción física:**
 - Encapuchado (capucha perpetua)
 - Alas de fuego negro
 - Masa relicaria (porta fragmento Veracruz)
 - Andrógeno fuego/escama: cuerpo superior fuego, inferior escama; cola serpentina
 - Unido por la espalda a segundo demonio (simetría andrógena)
 - Plumas + escamas (descripción: "sale azufre")
- **Alineamiento:** Caótico Malvado (confirmado)
- **Habilidades:**
