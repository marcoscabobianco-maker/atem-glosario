...
aliases:
 ...
 - Ely
 - Elysium
 - Plataformas primigenias del mundo-gema
categoria_diegetica: lugar
epoca: "nodo cosmológico activo desde el primigenio; fase de estancamiento desde antes del cómputo conocido en Caldero (1824 AE)"
ubicacion_principal: "atraviesa la totalidad del mundo-gema; manifestación geográfica en ambas ciudades-cráter (Caldero y Ciudad Estrella) y en otros pliegues"
tags:
 - lugar
 - cosmologia
 - mundo-gema
...
**Las [[Columna_concepto|columnas conceptuales]]** —*ejes abstractos constantes que la doctrina del Juego de las Sombras enuncia*— **operaban activas sobre las Plataformas**. *Cada columna tenía vehículo plataforma*; *cada plataforma vehiculaba una columna*. **El cosmos extendido se sostenía sobre esta infraestructura**, *junto con las plataformas paralelas de otros mundos hermanos*.

---

## La fase de estancamiento

**Las Plataformas han caído en una fase de estancamiento**. *Mascor Blancarba lo registra con cuidado*: ***"ahora ha caído en una fase de estancamiento, desconectada de otros reinos"***. **No están destruidas**; *operan*, *pero a media máquina*. **La función de intercambio entre planos** *que las definía* **se ha cerrado, o se ha vuelto opaca**.

*Las causas del estancamiento* **no se preservan con detalle en el archivo**. *Hipótesis cronistas registran*:

- **Cierre de los pliegues vecinos** que las Plataformas servían. *Si los reinos del intercambio se han cerrado o fragmentado*, **las Plataformas pierden función operativa**.
- **Fatiga de las columnas conceptuales**, *cuya energía rectora se ha debilitado con el ciclo cosmológico*.
- **Operación encubierta del polo negativo** —*alguno de los [[Papas_Borg|Papas Borg]] anteriores, o entidades infernales que abrieron pactos parciales en el mundo-gema*— *que apagó nodos de la red primigenia*.
- **Voluntad del cronista cosmológico mayor** *que cerró la función para preservar el cosmos de invasiones externas*.

*Las hipótesis no se excluyen mutuamente*. **Algunas operan en sinergia**.
...
## Las Islaires de los primeros habitantes

**Los primeros habitantes del mundo-gema** —*pueblo cuya etnia o procedencia el archivo no preserva con detalle*— **llamaron a las Plataformas "las Islaires"**. *Etimología no fijada*: posiblemente *"isla" + "aire"* (islas en el aire, plataformas suspendidas), *o "Ils + Aires"* (de los antiguos, los Otros), *o algo enteramente distinto en lengua perdida*.

**El nombre "Islaires"** se conserva *en algunos archivos heterodoxos* y *en boca de cronistas viejos como Mascor Blancarba*. **No se usa en boca corriente del ciudadano de Caldero o Ciudad Estrella**, que ha olvidado el término original.

---

## El antiguo Elysium

**Las Plataformas se relacionan con el antiguo Elysium** —*mito de los planos paradisíacos del cosmos extendido*— *no como contenido sino como infraestructura*. **Elysium no era "lugar"**; **era *modo de acceso* mediante las Plataformas a un estado cosmológico**. *Cuando las Plataformas operaban plenamente*, **el acceso a Elysium era posible**. *Tras el estancamiento*, **Elysium se volvió inaccesible o cuasi-inaccesible**.

*La equivalencia* **Vala = Ely = Elysium = Elysian** *no es sinonímica perfecta*; **es genealógica**:

- **Vala** = nombre del mundo-gema como totalidad
- **Ely** = nombre del plano primigenio dentro del mundo-gema, donde se accedía a Elysium
...
- [[Vala_Cristalis]] — mundo-gema del cual las Plataformas son infraestructura primordial
- [[Eilidh]] / **Ely / Elysium** — plano primigenio dentro del mundo-gema
- [[Caldero]] — ciudad-cráter construida sobre una Plataforma primigenia
- [[Ciudad_Estrella]] — ciudad-cráter construida sobre otra Plataforma
- [[Gran_Plaza_de_Obsidiana]] — manifestación geográfica visible de una Plataforma en Ciudad Estrella
- [[Fenix_Nido_Volcanico]] — manifestación geográfica visible en Caldero
- [[Juego_de_las_Sombras_Plataformas_Zodiacales]] — cosmología subyacente
- [[Columna_concepto]] — ejes abstractos que las Plataformas vehiculan
- [[Casa_Azul_de_Vala]] — linaje custodio de la infraestructura
- [[Revolucion_Industrial_Magica]] — explotación residual de la energía estancada
- [[Rio_Ucronos]] — río del tiempo que cruza el mundo-gema
- [[Papas_Borg]] — fuerza polo negativo que pudo haber influido en el estancamiento
- [[Linea_Arian_Avatares]] — línea trans-cosmológica que opera sobre las Plataformas
- **Mascor Blancarba** — cronista bardo que conserva la memoria de las Islaires

## Apariciones

- **Primigenio cosmológico** — operación plena de las Plataformas como pasarela entre planos
- **Período de los primeros habitantes** — denominación "Islaires" en boca corriente
- **Fase de estancamiento** — cierre de la función operativa; preservación residual
