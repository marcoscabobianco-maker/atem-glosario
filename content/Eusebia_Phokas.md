...
aliases:
 ...
 - Eusebia
 - La Tesmóteta
 - La administradora del alcaide
categoria_diegetica: personaje
epoca: "tesmotetía en Glastumville desde aproximadamente 2986 AEP"
ubicacion_principal: "oficina administrativa en la Fortaleza Azur, ala norte; reside con guardia menor en Glastumville al pie"
tags:
 - personaje
 - aristocrata-imperial
 - tesmoteta
 - administradora
 - phokas-casa
 - ardis-vala
...
## El acuerdo táctico con Sir Glastum

**La relación entre la tesmóteta y el alcaide** se sostiene en lo que el archivo decadiano llama *"acuerdo táctico"* —*fórmula que el aparato cancilleresco usa para describir las relaciones operativas que no son ni jerárquicas estrictas ni colegiadas plenas*—:

- **Eusebia lleva los libros**. **Glastum firma los sellos**.
- **Eusebia conoce el censo real de la villa**. **Glastum proclama el censo público**.
- **Eusebia anota el diezmo del dungeon cuando llega**. **Glastum cobra**.
- **Eusebia mantiene correspondencia con Narsileon**. **Glastum recibe los pliegos por intermedio de la tesmóteta**.

*La asimetría es deliberada*. **Eusebia tiene la información, Glastum tiene la patente**. **Ninguno opera sin el otro**. *El cronista decadiano lo registra como **sociedad asimétrica con beneficio mutuo**: ella necesita un alcaide que no insista en supervisar el flujo de la tesmotetia; él necesita una administradora que no insista en cuestionar el porqué del flujo*.

**Eusebia no comenta** la **tolerancia del alcaide hacia el santuario clandestino de [[Thoth]]** en la cámara lateral de la Fortaleza. **El alcaide no comenta** la **correspondencia privada de la tesmóteta con su red familiar**. *Cada uno respeta la zona ciega del otro*. **El aparato opera**.
...
El día tesmotético de Eusebia, *en formato que el archivo conserva por inferencia más que por documentación directa*:

- **Mañana**: revisión del libro mayor de la villa. Apuntes de pleitos menores, registros de patente nueva, cuentas de tributos.
- **Mediodía**: audiencia con mercaderes —*los **[[Mercaderes_Factoriales|Mercaderes Factoriales]]**, principalmente, con quienes la tesmóteta mantiene relación cordial pero formal*—.
...
El archivo decadiano **no preserva información personal extensa** sobre Eusebia. *Lo que se anota con cautela*:

- **Edad estimada**: *mediana, entre los treinta y cinco y los cuarenta y cinco años por la cuenta imperial*.
- **Estado**: *soltera, sin descendencia documentada*. *El cargo tesmotético, en la tradición Phokas, **se prefiere ejercido por miembro sin compromiso familiar pleno**, *para evitar conflictos de lealtad con la red familiar*.
- **Idiomas**: *archonteo imperial culto, lengua común del valle, latinizado eclesial, **conocimiento básico de la lengua thorcin del norte**, *conocimiento elemental del archonteo antiguo para pliegos arqueológicos*.
- **Predilecciones**: *el archivo no las precisa*. **Algunos pliegos rurales sugieren que la tesmóteta cultiva en privado un jardín pequeño dentro de la Fortaleza Azur** —*hierbas medicinales, plantas aromáticas, ninguna planta cuya propiedad ritual la Ortodoxia condene*—; **otros pliegos sugieren que la tesmóteta lee, en horas tardías de la noche, manuscritos antiguos de cancillería arqueológica** —*registros de la administración archontea pre-Cisma del valle*—. *La lectura no se ha confirmado*.

[*Eusebia es la administradora que el aparato imperial necesita en frontera: competente, discreta, sin ambición visible, leal a su casa y al cargo. Lo cual no significa que no tenga ambiciones invisibles. La cancillería sabe que los Phokas siempre tienen segunda capa. La tolera. —Glosa de [[Arkos]].*]

---

## El Hiato

*El paradero de Eusebia durante el Hiato es objeto de pregunta abierta*. Las hipótesis del archivo decadiano:
...
- [[Sir_Glastum]] — alcaide socio del acuerdo táctico
- [[Fortaleza_Azur]] — sede operativa
- [[Glastumville]] — jurisdicción tesmotética
- [[Argus_PJ|Barón Argus]] — autoridad baronial vecina, sin jurisdicción directa sobre Glastumville
- [[Theron_Glesteon]] — factor de la Casa de la Moneda, colaborador administrativo
...
- **Cancillería de Narsileon** — autoridad institucional superior
