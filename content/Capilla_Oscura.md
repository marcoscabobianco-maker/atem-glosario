...
aliases:
 ...
 - Capilla Oscura
 - Capilla Oculta
 - La Capilla del Cronomante
 - Capilla del Rito de Reconexión Sagrada
 - Catedral Oscura de Caldero
categoria_diegetica: lugar
epoca: "construida en la fase de forja cosmológica de Caldero, anterior al cómputo conocido; activa con anomalías nocturnas en el ciclo presente"
ubicacion_principal: "Caldero, sub-estructura sagrada cuya entrada principal conserva nave abovedada y cripta; vinculada al volcán dormido sobre el que la ciudad se asienta"
tags:
 - lugar
 - capilla
 - catedral-oscura
...
## El rito de Reconexión Sagrada

El acto que selló cosmológicamente a la Capilla Oscura **es uno de los eventos mayores del cosmos extendido**: **el rito de Reconexión Sagrada**, *intento de anclar las líneas temporales a una sola verdad*.

### Lo que ocurrió

En la época en que **Caldero comenzaba a forjar su fama de ciudad de convergencias mágicas**, *la Capilla Oscura atrajo la atención de fuerzas infernales*. **Los diablos** —*intrigados por la energía temporal que fluye bajo el volcán donde se asienta Caldero*— **enviaron una embajada para establecer acuerdos secretos** con ciertos clérigos y magos locales del aparato eclesial caldera. **El polo negativo del cosmos extendido buscaba penetrar el pliegue temporal**.

**En aquel entonces apareció [[Pablo_el_Cronomante|Pablo el Cronomante]]** —*viajero del tiempo cuyas artes permitían saltos breves entre distintos momentos de la historia*—. *Sus poderes resultaban valiosos para los seres infernales* que, según algunos textos, **pretendían manipular sucesos clave y consolidar su influencia en el plano mortal**. *Pablo no operaba con voluntad infernal*; *operaba con sus propios designios temporales*. **Pero su don era cosmológicamente atractivo para los embajadores diabólicos**, *que lo procuraron para su empresa*.

**Sin embargo, la intervención de [[Los_Reguladores]] y [[Templarios_del_Tiempo]]** —*brazo clandestino de la justicia temporal del cosmos extendido*— **cambió el curso de la negociación**. *Estos paladines eran famosos por sus métodos radicales*, **llegando a la inmolación de uno de los suyos si con ello se restauraba el equilibrio cronológico**.
...
### Lo que el rito selló

*El rito tuvo efecto cosmológico*:
...
## La continuidad cronomántica: Pablo

**[[Pablo_el_Cronomante|Pablo el Cronomante]]** —*figura del rito de Reconexión Sagrada en Caldero*— **es figura cosmológica mayor** del cosmos extendido. *Su nombre*, *sus artes temporales*, *su capacidad de saltos cronológicos*, **lo asocian con [[Pablo_de_Alejandria|Pablo de Alejandría]]** *(la consolidación reciente de 9 variantes Pablo en una sola figura cosmológica)*, **con [[Pablo_Viajero_Temporal_Primigenio|Pablo Viajero Temporal Primigenio]]**, *con el portador de la **[[Eisagogika|Isagógica de Pablo]]***. **Las manifestaciones de Pablo en el cosmos extendido son múltiples**; **la Capilla Oscura conserva una de las más documentadas**.

*El salto en el tiempo de emergencia* que Pablo realizó al atrapar entre Reguladores e diablos **lo trasladó a otra geografía cosmológica**, *donde su operación continuó*. **El eco que dejó en las criptas** *es lo que el cosmos extendido conserva como rastro de su paso*. **Pablo no murió en la Capilla Oscura**; *cambió de pliegue*.

---

## Las anomalías del ciclo presente

**En el ciclo presente del archivo de Caldero** —*1824 AE*— **la Capilla Oscura permanece como nodo prohibido**:

- **Cerrada al culto activo**: *ningún clero opera liturgia regular en la nave principal*; *el aparato eclesial caldera la considera consagrada-pero-sellada*.
- **Anomalías nocturnas documentadas**: *susurros en cánticos antiguos*, *símbolos arcanos a fuego en la piedra*, *visiones de embajadores diabólicos en la penumbra de los muros*, *ecos de Pablo el Cronomante operando saltos cuya destinación no se preserva*.
- **Vigilancia eclesial discreta**: *el aparato eclesial caldera mantiene observación en torno a la Capilla*; *no entra*, *pero observa quién entra*. *Algunos miembros de **[[La_Jabalina]]** han pasado cerca sin penetrar*.
- **Posible pacto residual**: *si el embajador diabólico principal selló un pacto antes de escapar* —*como sostiene una de las lecturas*—, *la Capilla* **puede seguir operando como **nodo de penetración cosmológica diabólica** *en estado dormido*. *La activación de tal nodo* **sería evento mayor del próximo ciclo**.

*El archivo no resuelve si la Capilla Oscura es **monumento cerrado** o **nodo activo en pausa***. **La doctrina operativa** —*mientras no se demuestre lo contrario*— **es tratarla como nodo activo dormido**.

---

## La función estructural en el cosmos extendido
...
- [[Caldero]] — ciudad cuya geografía custodia la Capilla
...
- [[Arsvan]] — paralelo cosmológico del paladín inmolado en otro pliegue
- [[Papas_Borg]] — papado oscuro cuya contención fue posibilitada por el rito de la Capilla
- [[Casa_Azul_de_Vala]] — linaje custodio del cristal mayor, presencia en Caldero
- [[Vala_Cristalis]] — velo cristalino cosmológico cuya estabilidad se sostiene en cosidos como el de la Capilla
...
- **Fase de forja cosmológica de Caldero** — consagración primigenia de la Capilla, anterior al cómputo conocido
