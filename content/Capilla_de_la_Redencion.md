...
aliases:
 ...
 - La Capilla de la Redención
 - Capilla del Espejo
 - La Redención (capilla)
categoria_diegetica: lugar
epoca: "consagración en el sellado del pacto Ishen-Nalía, era primigenia; presencia ritual continuada en el ciclo presente"
ubicacion_principal: "Caldero, capilla menor cerca del trazado urbano alto; cripta pequeña con altar de plata oxidada"
tags:
 - lugar
 - capilla
 - caldero
...
**El altar no tiene cruz ni imagen del santo**: tiene espejo. **El espejo no refleja al visitante con claridad**: la plata mate devuelve siluetas borrosas, contornos, sombra del rostro sin facciones precisas. *La doctrina del lugar*: **el espejo no refleja al visitante, refleja a la Luna**. *Quien se mira en el espejo de la Capilla* **se mira como la Luna lo mira**.

[*La práctica popular es dejar una moneda sobre el espejo en luna nueva. Quienes saben dejan, en cambio, un objeto sin valor pero con uso —botón, cordón, lágrima literal—. La Serpiente, dicen, prefiere lo que el cuerpo usó. —Glosa de [[Arkos]] el archivero del Plata.*]

---

## La continuidad ritual en el ciclo presente

**En 1824 AE**, la Capilla **opera con presencia ritual continuada**:
...
- [[Mito_de_los_Amantes_y_la_Serpiente_Lunar]] — mito consagrado en este locus
- [[Serpiente_Luna_Auna]] — figura mítica del pacto sellado aquí
- [[Capilla_Oscura]] — nodo paralelo de sellado, simetría inversa
- [[Templo_de_San_Cutberto]] — templo decadiano ortodoxo del trazado urbano alto
- [[Caldero]] — ciudad
- [[Vala_Cristalis]] — mundo-gema cuyo orden primigenio se selló aquí
- [[Mascor_Blancarba]] — cronista que compila el mito
- **Espejo de plata** — altar central
- **Cántico de Nalía** — fragmento ritual continuado

## Apariciones

- **Era primigenia** — consagración por el pacto Ishen-Nalía; sellado de la Serpiente-Luna
