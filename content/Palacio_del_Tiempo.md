...
aliases:
 - Palacio del Tiempo
 - El Palazzo del Tempo
 - Sede de los Prefectos del Tiempo
 - Ministerio de las Diramaciones Temporales
categoria_diegetica: lugar
epoca: "Belle Époque uchrónica; operación continuada en el ciclo presente de París Ucrónica"
ubicacion_principal: "París Ucrónica; sede arquitectónica monumental con archivos cronológicos y burocracia de viajes"
tags:
 - lugar
 - palacio
 - paris-ucronica
...
**El Palacio del Tiempo** —*"Palazzo del Tempo"* en la grafía formal del aparato, *"Ministerio de las Diramaciones Temporales"* en la nomenclatura oficial decadiana de [[Paris_Ucronica|París Ucrónica]]— **es sede arquitectónica monumental** del cuerpo de Prefectos cronos. *La Belle Époque uchrónica*, *al diferencia de la Belle Époque común*, **admite el viaje temporal como tránsito administrable**: **el Palacio del Tiempo lo administra**.

*La estructura interna*: **archivos cronológicos por planta**, **oficinas de Prefectura del Tiempo distribuidas por departamentos temáticos** *(diramaciones presentes, diramaciones pasadas, diramaciones futuras, casos especiales de paradoja)*, **antesalas para los [[Cronoboys|Cronoboys]]** que esperan validación de pasaje, **tribunales menores para disputas cronométricas**.
...
- **Prefectos del Tiempo** — *cuerpo colegiado del aparato; nombres específicos pendientes de documentación canónica*.
- **Archiveros del cronos** — *cuerpo subalterno que mantiene los registros de trayectos*.
- **Tribunales menores cronométricos** — *operadores de la justicia administrativa del aparato*.
...
- [[Time_Bandits]] — cuerpo cronomáctico con el que el Palacio coordina ocasionalmente
- [[Pablo_de_Alejandria]] — figura cuya línea cronomántica el Palacio registra sin alcanzar a contener
