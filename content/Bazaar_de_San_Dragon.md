...
El **Manual of the Planes original** ( 1e) catalogó por primera vez los **Outer Planes** y sus habitantes. Criaturas relevantes para el setting:
...
El **Papa accede al poder luminoso del plano energético positivo** —**fuente del catálogo planar clásico**—. Los **[[Custodes_Oculis_Solis]]** que sirven al Papa pueden ser:

- **Devas adaptadas** al setting del ciclo (luz dorada solidificada)
- **Movanic devas** con estética sincretizada egipcio-planar
- **Híbridos custom** del Bazaar de San Dragón

### Posiciones cosmológicas

El Bazaar funciona como **mercado planar** —análogo a **Sigil** (la ciudad-rueda de Planescape) o a la **Astral Plane** general— donde **criaturas planares se encuentran**. En el setting del ciclo, el Bazaar:
...
- [[Mundo_de_Archontos]] — setting de la campaña
- **Manual of the Planes ( 1e, 1987)** — fuente de las criaturas planares
