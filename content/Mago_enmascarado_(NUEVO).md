...
meta: M
image: _assets/SaintGermain/ATEM__SaintGermain__MMF__Mago_enmascarado__NUEVO_retrato.png
image_status: pending
nexus_status: APPROVED
---

# ATEM::SaintGermain::MMF::Mago enmascarado (NUEVO)

> [!image-pending] Generar imagen
> **Slot:** `_assets/SaintGermain/ATEM__SaintGermain__MMF__Mago_enmascarado__NUEVO_retrato.png`
> **Prompt sugerido:** Ilustración de ATEM::SaintGermain::MMF::Mago enmascarado (NUEVO). Estilo coherente con la campaña.
> **Notas:** Reemplazar wikilink de abajo cuando este la imagen.

![[ATEM__SaintGermain__MMF__Mago_enmascarado__NUEVO_retrato.png]]
...
**sesiones donde aparece:** S8

## Justificación

'El mago enmascarado se animó a tanto' (S8 ¶1277). Identidad posible: Marsilio (asociado a libros prohibidos) o nuevo NPC. CONFIRMAR.
