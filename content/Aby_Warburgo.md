...
epoca: "Belle Époque uchrónica — actividad documentada 1900-1901 y reapariciones cronománticas en Constantinopla 1051-1055"
ubicacion_principal: "París, Bucarest, Constantinopla — itinerario continuo de los Time Bandits"
tags:
 - personaje
 - time-bandits
 - paris-ucronica
...
## El arco París–Bucarest–Constantinopla

**Su trayectoria con el grupo cubre el itinerario completo** del arco Belle Époque:
...
## Los logros cronománticos mayores

**El archivo conserva varios episodios técnicos donde Aby opera al máximo**:

- **Identificación de [[Zygomind]] mediante Visualización de la Mente** —*score 55, primera identificación documentada de este ente proveniente de [[Aldebaran_Estrella_Plataforma|Aldebarán]]*—.
...
## El posicionamiento doctrinal

**En el debate post-[[Juegos_Funebres|Juegos Fúnebres]] de Constantinopla**, **Aby toma posición pragmática-integradora**: *discurso clave* —**"nunca separarse de la persona que está a tu lado"**—; **"los gobernantes son inventos de demonios y diablos"**; **apoya la moción de Claude**; **prioriza el viaje temporal como objetivo grupal**; **propone como contribución personal su conocimiento de historia y de estrategia militar contra turcos**.

*Funciona como cohesionador del grupo* entre la posición revolucionaria de Claude y la posición estratégica de [[Philippe]]; **el centro táctico que el grupo encuentra cuando se discute la dirección a tomar**.

**Planeta asignado**: **Mercurio** —*el de la velocidad, el del comercio entre mensajes, el del intermediario*—; **asignación que el archivero del Plata anota como coherente con su función de puente doctrinal**.

[*"Hay académicos que descomponen el ritual; hay monjes que lo viven. Aby los hace a los dos al mismo tiempo, lo cual es más raro de lo que las academias respetables admiten." — Glosa del libro V del [[Decadiano]].*]
