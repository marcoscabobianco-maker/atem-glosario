...
aliases:
 - Corrupción Dual
 - Ley de los Guardianes
 - regla del relevo zodiacal
categoria_diegetica: concepto
epoca: "vigente desde la instalación del Juego de las Sombras; primer caso documentado en 835 A.D.A. (cuerpo de Mago en Venecia)"
ubicacion_principal: "sistema de las doce plataformas zodiacales"
tags:
 - concepto
 - mecanica-cosmica
 - guardianes
...
El sistema **no premia con libertad**: **conscribe**. Esta es la lectura severa del archivero. La lectura indulgente, que algunos teólogos del [[Decadiano]] proponen, lee el relevo como **purificación cíclica**: cada guardián nuevo aporta sangre fresca a la columna, y la columna se renueva sin perder su esencia. *Las dos lecturas son verdaderas: el guardián padece, la columna se sostiene.*

## La plataforma como prisión

La cláusula técnica que explica por qué la regla no admite excepción está enunciada en la doctrina primigenia: **la plataforma es la prisión del guardián**. El guardián no la habita: la ocupa porque no puede salir. La columna del concepto —violencia, vanidad, codicia, lo que sea— **lo retiene como el imán retiene el clavo**. Quien lo libera, lo sustituye. *No hay puerta para irse sin abrir otra para quedarse.*

Por eso [[Gabriel_Guardian_de_Aries|Gabriel]] sigue en [[Plataforma_Aries|Aries]] aunque su naturaleza lo arrastre; por eso [[Erzebeth]] heredará [[Plataforma_Tauro|Tauro]] cuando llegue el ciclo. La conscripción es estructural.
