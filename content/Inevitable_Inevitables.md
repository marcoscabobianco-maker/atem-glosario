...
**En el archivo:**
- Agente alemán presenta contrato mágico a [[Time_Bandits|Time Bandits]] ofreciendo recompensa para destruir [[Apis]] O capturar [[Draga_Machine|Draga Machine]].
...
- Contraste con divinidades/magia: mientras magia es fluida, variable, libre; leyes Inevitable son rígidas, deterministas.
- Tema el archivo: tensión entre libre albedrío ([[Draga_Machine|Draga]] ama a Aleksandar) y destino cósmico (reabsorción obligatoria).
