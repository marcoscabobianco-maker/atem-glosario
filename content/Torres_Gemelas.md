...
aliases:
 - Torres Gemelas
 - Las Torres Gemelas
 - Las Torres de la Casa Frame Rhivadi
categoria_diegetica: lugar
epoca: "construcción de fase noble alta de Caldero; sede activa en 1824 AE"
ubicacion_principal: "Caldero, sector noble alto; dos torres pareadas con pabellón de recibimiento entre ambas, jardines compartidos"
tags:
 - lugar
 - torres
 - caldero
 - sede-frame-rhivadi
 - titti-frame-residencia
 - matine-fiesta
 - brazos-mecanicos-taller-sospechado
...
## La arquitectura *(voz Mascor Blancarba)*
...
## La torre norte y la torre sur

*El archivo conserva nomenclatura interna* —*reconstruida a partir de los criados, de proveedores, de invitados formales*—:

- **Torre norte**: **sede pública de [[Titti_Frame|la dama Frame Rhivadi]]**. *Salones de recibimiento*, *biblioteca formal con escolios decadianos ortodoxos*, *aposentos de alta sociedad*, *galería de retratos de la familia*. **Aquí se opera la imagen pública de la Casa**.
- **Torre sur**: **sede operativa clandestina**. *Laboratorios sellados sospechados* —*donde "se traman planes para consolidar el poder de unos pocos"*—, *taller arcano* (*el origen misterioso de la tecnología de brazos mecánicos*), *aposentos privados* (*donde la dama opera con discreción que ningún criado se atreve a contradecir*).

**Entre ambas torres**, **el pabellón** *opera como espacio liminal*: **lo que la torre norte admite con sonrisa y lo que la torre sur prepara con disciplina se encuentran allí**, **mezclados con champagne y conversación**.
...
*Al día siguiente*, **telegrama de despido al hechicero**: *"No toleraré subversiones en mi casa. Adiós."*

---

## El taller sospechado
...
- [[Titti_Frame]] — anfitriona y operadora
- [[Casa_Frame_Rhivadi]] — familia noble
- [[Lord_Valanthru]] · [[Torre_de_Obsidiana]] — nodo paralelo
- [[La_Jabalina]] — grupo cuyos miembros fueron expulsados tras la matiné
- [[Vitalis]] — hechicero del tiempo contratado y despedido
- [[Teo_Paladin_Sin_Brazo]] — paladín candidato a brazo mecánico
- [[Cageewrights]] — profecía con la que el aparato coordina
- [[Miles_Corp]] — proveedor sospechado de tecnología industrial-mágica
- [[Papas_Borg]] — papado oscuro cuyo cuerpo arquitectónico técnico-arcano prepara
- [[Caldero]] — ciudad
- **Pabellón de recibimiento** — espacio liminal entre las dos torres
