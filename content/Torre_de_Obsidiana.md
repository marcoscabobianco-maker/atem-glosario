...
aliases:
 ...
 - Residencia Valanthru
categoria_diegetica: lugar
epoca: "construcción de fase industrial-mágica intermedia; residencia activa en 1824 AE"
ubicacion_principal: "Caldero, sector noble alto; torre única de piedra negra brillante, jardín cerrado, dron hechicero perimetral"
tags:
 - lugar
 - torre
 - caldero
...
**La torre opera como nodo de la conspiración mayor**:

- **Coordinación con la [[Casa_Frame_Rhivadi|Casa Frame Rhivadi]]** *vía visitas formales y correspondencia codificada*; **proyectos compartidos de brazos mecánicos** *y de marcas zodiacales en niños*.
- **Vínculo con la profecía [[Cageewrights]]**: *si el ritual zodiacal opera*, **el niño adoptado es uno de los elegidos**, *la torre es uno de los nodos donde el ritual se prepara*.
- **Eco del [[Papas_Borg|Papa Borg]] en clave industrial-mágica**: *si la torre es el cuerpo arquitectónico del próximo Papa Borg*, **Valanthru opera dentro como vehículo gestante**.
- **Observatorio del mirador**: *la vista nocturna del cráter de Caldero* **alinea con plataformas zodiacales**; **el ritual de las marcas requiere observación astronómica**.

*La torre no es residencia; es maquinaria ritual residencial*. **Quien la habita opera con el aparato**.

---

## Vínculos

- [[Lord_Valanthru]] — habitante y operador
- [[Ayrton_Auslander]] — infiltrador fallido
- [[Casa_Frame_Rhivadi]] · [[Torres_Gemelas]] — nodo paralelo de la conspiración
- [[Cageewrights]] — profecía con la que la torre coordina
- [[Bazar_de_la_Vida]] — origen del niño adoptado
- [[Miles_Corp]] — proveedor probable del dron hechicero
- [[Papas_Borg]] — papado oscuro cuya manifestación industrial-mágica gestionaría la torre
- [[Plataformas_Zodiacales_Sistema_de_Guardianes]] — infraestructura ritual observada desde el mirador
- [[Compania_de_la_Risa]] — sicarios bajo coordinación probable
- [[Caldero]] — ciudad
