...
aliases:
 - El Milagro de Miles
 - Milagro de Miles
 - El vuelo mágico de Ciudad Estrella
categoria_diegetica: concepto
epoca: "innovación tecnológico-mágica activa desde la aceleración de la Revolución Industrial Mágica"
ubicacion_principal: "fabricado en Ciudad Estrella por Miles Corp; exportado a Caldero y otras geografías del mundo-gema"
tags:
 - concepto
 - innovacion
 - vuelo-magico
...
**El Milagro de Mileses el producto-signature de [[Miles_Corp]]** *en el ciclo presente de la [[Revolucion_Industrial_Magica]]*. **Vuelo mágico impulsado por encantamiento** *integrado en escobas voladoras y otros artilugios aéreos*. **Permite a las élites moverse rápidamente por la ciudad** *sin depender de los medios convencionales* (caminata, montura, carruaje).

*Tecnología en desarrollo*: **aún no perfecta**, **aún no masiva**, **aún no asequible para la mayoría**. *Pero* **ya está transformando la forma en que las personas más ricas se desplazan**.

---

## La controversia social

**El Milagro opera con doctrina dual**:
...
- [[Miles_Corp]] — empresa fabricante
- [[Ciudad_Estrella]] — origen de la innovación
...
- [[Lord_Valanthru]] / [[Titti_Frame]] — solicitantes de artilugios voladores Miles
